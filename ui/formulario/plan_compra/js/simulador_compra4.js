...
$(function () {
    ...
    $('#tipos_export').on('change', function () {
        ...
        if (tipo == 3) {
           ...
           // $('#bmt_export').append('<td  class="txt_colum_descrip_caber"  id="txt_colum_descrip_caber">_____________</td>');
           // $('#bmt_export').append('<td colspan="2"><label class="titulo" id="titulo" for="tipos">Grupo Compra:</label></td>');

            $.getJSON(url_tabla, function (data) {
                $.each(data, function (i,o) {
                    $('#bmt_export').append('<tr class = "check_gr">\n' +
                            '<td class= "checkbox_grupo" id="txt_id_check'+flag_tabla2+'"><input type="checkbox" id="checkbox_grupo" name="check[]" value="'+o[0]+'" onchange="validar()" ></td>\n' +
                            '<td class="ids" id="txt_id_'+flag_tabla2+'">'+o[0]+'</td>\n' +
                            '</tr>');
                    flag_tabla2++;
                    });
...
/*################################ trabajo de llenar tabla ########################*/
            var url_carga_tabla2 = 'ajax_simulador_cbx/llenar_tabla_depto';
            var flag_tabla2 = 0 ;
            $.getJSON(url_carga_tabla2, function (data) {
                $.each(data, function (i,o) {
                    $('#depto_tabla_selec').append('<tr>\n' +
                        '<td id="txt_id_check'+flag_tabla2+'"><input type="checkbox"  id="check_depto"  name="check_depto[]" value="'+o[0]+'" onchange="validarc1()"></td>\n' +
                        '<td class="ids" id="txt_id_'+flag_tabla2+'">'+o[0]+'</td>\n' +
                        '<td class="ids" id="txt_id_'+flag_tabla2+'">'+o[1]+'</td>\n' +
                        '</tr>');
                    flag_tabla2++;
                });
    });
/*################################ trabajo de llenar tabla ########################*/
            ...
            var url_carga_tabla3 = 'ajax_simulador_cbx/llenar_tabla_depto';
            var flag_tabla3 = 0 ;
            $.getJSON(url_carga_tabla3, function (data) {
                $.each(data, function (i,o) {
                    $('#depto_tabla_selec').append('<tr>\n' +
                        '<td id="txt_id_check'+flag_tabla3+'"><input type="checkbox"  id="check_depto_estado"  name="check_depto_estado[]" value="'+o[0]+'" onchange="validarc1_estado_depto()"></td>\n' +
                        '<td class="ids" id="txt_id_'+flag_tabla3+'">'+o[0]+'</td>\n' +
                        '<td class="ids" id="txt_id_'+flag_tabla3+'">'+o[1]+'</td>\n' +
                        '</tr>');
                    flag_tabla3++;
                });
            });
            /*################################ trabajo de llenar tabla op 4 ########################*/
            var url_carga_tabla4 = 'ajax_simulador_cbx/llenar_tabla_oc';
            var flag_tabla4 = 0 ;
            $.getJSON(url_carga_tabla4, function (data) {
                $.each(data, function (i,o) {
                    $('#depto_tabla_selec_opcion').append('<tr>\n' +
                        '<td id="toc_id_check'+flag_tabla4+'"><input type="checkbox"  id="check_estado"  name="check_estado[]"  value="'+o[0]+'" onchange="validarc1_estado_depto()"></td>\n' +
                        '<td class="ids" id="oc_id_'+flag_tabla4+'">'+o[1]+'</td>\n' +
                        '</tr>');
                    flag_tabla4++;
                });
            });
            ...
            $("#btn_exportar").attr("disabled", "disabled");
            /*################################ trabajo de llenar tabla ########################*/
            var url_exp_assortment_carga_tabla2 = 'ajax_simulador_cbx/llenar_tabla_depto';
            var flag_tabla2 = 0 ;
            $.getJSON(url_exp_assortment_carga_tabla2, function (data) {
                $.each(data, function (i,o) {
                    $('#depto_tabla_selec').append('<tr>\n' +
                        '<td id="txt_id_check'+flag_tabla2+'"><input type="checkbox"  id="check_depto"  name="check_depto[]" value="'+o[0]+'" onchange="validarc1()"></td>\n' +
                        '<td class="ids" id="txt_id_'+flag_tabla2+'">'+o[0]+'</td>\n' +
...
$(window).on('load', function () {
   ...
   // codigo que valida el usuario tipo lectura ...
    ...
    $.getJSON(url_busca_cod_tip_usr, function (data) {
        $.each(data, function (i, c) {
            ...
            if ((c[0] != null) || (c[0] != '') || (c[0].length > 0)) {
                ...
                alert ("No se a determinado tu tipo de usuario");
    ...
    //var url_busca_estado_oc_pmm = 'ajax_simulador_cbx/busca_estado_oc_pmm'; // Devuelve: ESTADO, COD_ESTADO
    ...
    $.getJSON(url_busca_oc20, function (data) {
        $.each(data, function (i,o) {
            ...
            // Valor de la OC
            //if( o[1] > 0 ){ // Esta de mas dice lalo 13-07-2018 15:30
        ...
        $.getJSON(url_carga_tabla2, function (data) {
            ...
            $.each(data, function (i,o) {
                $('#tabla2').append('<tr>\n' +
                    ...
                    '<td class="columnas" id="cbx_color_'+flag_tabla2+'">'+o[21]+'</td>\n' +
                    ...
                    '<td class="columnas" id="cbx_tipoproducto_'+flag_tabla2+'">'+o[22]+'</td>\n' +
                    '<td class="columnas" id="cbx_tipoexhibicion_'+flag_tabla2+'">'+o[23]+'</td>\n' +
                    '<td class="columnas" id="txt_tallas_'+flag_tabla2+'">'+o[24]+'</td>\n' +
                    '<td class="columnas" id="txt_tipoempaque_'+flag_tabla2+'">'+o[25]+'</td>\n' +
                    '<td id="txt_compraini_'+flag_tabla2+'">'+o[26]+'</td>\n' +
                    '<td class="columnas" id="txt_compraajust_'+flag_tabla2+'">'+o[27]+'</td>\n' +
                    ...
                    '<td class="columnas" id="txt_curva_'+flag_tabla2+'">'+o[28]+'</td>\n' +
                    '<td id="txt_curvamin_'+flag_tabla2+'">'+o[29]+'</td>\n' +
                    '<td id="txt_uniini_'+flag_tabla2+'">'+o[30]+'</td>\n' +
                    '<td id="txt_uniajust_'+flag_tabla2+'">'+o[31]+'</td>\n' +
                    '<td class="columnas" id="txt_unifinal_'+flag_tabla2+'">'+o[32]+'</td>\n' +
                    '<td id="txt_mst_'+flag_tabla2+'">'+o[33]+'</td>\n' +

                    '<td id="btn_ncajas_'+flag_tabla2+'"><button id="btn_ncajas_'+flag_tabla2+'" name="btn_ncajas_'+flag_tabla2+'" style="width:70px; height:25px" class="btn_ncajas_ btn btn-primary fa fa-archive btn-sm" value="'+o[34]+'" onclick="despliegaAjustCajas(event);"> '+o[34]+'</button></td>\n' +

                    '<td class="columnas" id="cbx_cluster_'+flag_tabla2+'">'+o[35]+'</td>\n' +
                    '<td class="columnas" id="cbx_formato_'+flag_tabla2+'">'+o[36]+'</td>\n' +
                    '<td id="txt_tdas_'+flag_tabla2+'">'+o[37]+'</td>\n' +
                    '<td class="columnas" id="txt_a_'+flag_tabla2+'">'+o[38]+'</td>\n' +
                    '<td class="columnas" id="txt_b_'+flag_tabla2+'">'+o[39]+'</td>\n' +
                    '<td class="columnas" id="txt_c_'+flag_tabla2+'">'+o[40]+'</td>\n' +
                    '<td class="columnas" id="txt_i_'+flag_tabla2+'">'+o[41]+'</td>\n' +
                    '<td id="txt_primeracarga_'+flag_tabla2+'">'+o[42]+'</td>\n' +
                    '<td id="txt_tiendas_'+flag_tabla2+'">'+o[43]+'% </td>\n' +
                    '<td class="columnas" id="cbx_proced_'+flag_tabla2+'">'+o[44]+'</td>\n' +
                    '<td class="columnas" id="cbx_via_'+flag_tabla2+'">'+o[45]+'</td>\n' +
                    '<td class="columnas" id="cbx_pais_'+flag_tabla2+'">'+o[46]+'</td>\n' +
                    '<td class="columnas" id="txt_viaje_'+flag_tabla2+'">'+o[47]+'</td>\n' +
                    '<td id="txt_mkup_'+flag_tabla2+'">'+o[48]+'</td>\n' +
                    '<td class="columnas" id="txt_precioblanco_'+flag_tabla2+'">'+o[49]+'</td>\n' +
                    '<td id="txt_gm_'+flag_tabla2+'">'+o[50]+'% </td>\n' +
                    '<td class="columnas" id="cbx_moneda_'+flag_tabla2+'">'+o[51]+'</td>\n' +
                    '<td class="columnas" id="txt_target_'+flag_tabla2+'">'+o[52]+'</td>\n' +
                    '<td class="columnas" id="txt_fob_'+flag_tabla2+'">'+o[53]+'</td>\n' +
                    '<td class="columnas" id="txt_insp_'+flag_tabla2+'">'+o[54]+'</td>\n' +
                    '<td class="columnas" id="txt_rfid_'+flag_tabla2+'">'+o[55]+'</td>\n' +
                    '<td class="columnas" id="txt_royalty_'+flag_tabla2+'">'+o[56]+'</td>\n' +
                    '<td id="txt_costounitariofinalusd_'+flag_tabla2+'">'+o[57]+'</td>\n' +
                    '<td id="txt_costounitariofinalpeso_'+flag_tabla2+'">'+o[58]+'</td>\n' +
                    '<td id="txt_totaltargetusd_'+flag_tabla2+'">'+o[59]+'</td>\n' +
                    '<td id="txt_totalfobusd_'+flag_tabla2+'">'+o[60]+'</td>\n' +
                    '<td id="txt_costototalpesos_'+flag_tabla2+'">'+o[61]+'</td>\n' +
                    '<td id="txt_totalretailpesos_'+flag_tabla2+'">'+o[62]+'</td>\n' +
                    '<td id="txt_debutreorder_'+flag_tabla2+'">'+o[63]+'</td>\n' +
                    '<td id="txt_semini_'+flag_tabla2+'">'+o[64]+'</td>\n' +
                    '<td id="txt_semfin_'+flag_tabla2+'">'+o[65]+'</td>\n' +
                    '<td id="txt_semanasciclovida_'+flag_tabla2+'">'+o[66]+'</td>\n' +
                    '<td id="txt_agotobj_'+flag_tabla2+'">'+(o[67]*100)+'</td>\n' +
                    '<td id="txt_semanasliquidacion_'+flag_tabla2+'">'+o[68]+'</td>\n' +
                    '<td class="columnas" id="txt_proveedor_'+flag_tabla2+'">'+o[69]+'</td>\n' +
                    '<td class="columnas" id="cbx_razonsocial_'+flag_tabla2+'">'+o[70]+'</td>\n' +
                    '<td class="columnas" id="cbx_trader_'+flag_tabla2+'">'+o[71]+'</td>\n' +
                    '<td class="columnas" id="txt_cod_sku_proveedor_'+flag_tabla2+'">'+o[72]+'</td>\n' +
                    '<td class="txt_cod_padre_" id="txt_codpadre_'+flag_tabla2+'" onclick="matchOC(event);">'+o[73]+'</td>\n' +
                    '<td class="columnas" id="txt_td_proforma_'+flag_tabla2+'"><input type="text" id="txt_proforma_'+flag_tabla2+'" style="font-size: 10px" name="txt_proforma_'+flag_tabla2+'" class="input-sm txt_proforma_" value="'+o[74]+'" size="9" onchange="actualizaCampoEstadoProforma(event);"></td>\n' +
                    ...
                    '<td class="columnas" id="txt_archivo_'+flag_tabla2+'"><span id="txt_archivo_span_'+flag_tabla2+'">'+o[75]+'</span><button id="txt_archivo_'+flag_tabla2+'" name="txt_archivo_'+flag_tabla2+'" class="txt_archivo_ btn btn-primary fa fa-upload btn-sm archivo_'+flag_tabla2+'" style="font-size: 10px" onclick="cargaArchivo(event);"> Upload</button></td>\n' +
                    ...
                    '<td id="txt_estiloppm_'+flag_tabla2+'">'+o[76]+'</td>\n' +
                    '<td id="txt_estadomatch_'+flag_tabla2+'">'+o[77]+'</td>\n' +
                    '<td id="txt_noc_'+flag_tabla2+'">'+o[78]+'</td>\n' +
                    '<td id="txt_estadooc_'+flag_tabla2+'">'+o[79]+'</td>\n' +
                    '<td id="txt_fechaembarque_'+flag_tabla2+'">'+o[80]+'</td>\n' +
                    '<td id="txt_fechaeta_'+flag_tabla2+'">'+o[81]+'</td>\n' +
                    '<td id="txt_fecharecepcioncd_'+flag_tabla2+'">'+o[82]+'</td>\n' +
                    '<td id="txt_diasatrasocd_'+flag_tabla2+'">'+o[83]+'</td>\n' +
                    '<td id="cbx_estadoopcion_'+flag_tabla2+'">'+o[84]+'</td>\n' +
                    '<td id="txt_estadoc1_'+flag_tabla2+'" style="display: none">'+o[85]+'</td>\n' +
...
console.log(data);
            ...
            //aqui se genera un delay para fijar la cabecera//
...
$('.guarda_proforma').on('click', function () {
    ...
    if (respuesta == true) {
        ...
        $("#tabla2 >tbody >tr").each(function () {
            ...
            // Verificar que el campo sea distindo de undefined y espacio (Para no considerar las cabeceras)
            //if ( (typeof(correlativo_tabla) != "undefined") && (correlativo_tabla!="")){ // && (correlativo_tabla.length>0)
                ...
                if( (busca_campo_actualizado == "U") && (estado_c1 == 0)){
                    ...
                    //alert("Correlativo: "+correlativo_tabla+" Proforma: "+proforma+" ID Color3: "+id_color);
                ...
                // Fin del if de no estar en cabecera
            //}
...
$('.solicitud_generacion_oc').on('click', function () {
    ...
    // alert("ID: "+valor_radio+" PROFORMA: "+proforma+" ID_COLOR3: "+id_color3);
...
$('.crear_modificacion').on('click', function () {   /// Revisar
    var valor_radio = $("input[name='radio']:checked").val();
    var proforma = $("#txt_proforma_"+valor_radio).val();
    proforma = proforma.replace(/[^a-z0-9\-]/gi,'');
    var id_color3 = $("#txt_id_color_"+valor_radio).text();
...
function despliegaAjust(event) {
    ...
    var dttalla = talla.split(",");
     $('#tablajustcom thead' ).empty();//limpiar la tabla
...
function Validar_flag_concurrencia_usuario_log() {
    ...
    var flag_lectura = $('#flag_top_menu_tipo_usuario').text();
