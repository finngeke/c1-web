...
<script src="{{@TELERIK}}ui/formulario/plan_compra/js/simulador_compra_permisos.js?v={{rand(0,999999)}}"></script>
...
<script src="{{@TELERIK}}ui/formulario/plan_compra/js/simulador_compra203.js?v={{rand(0,999999)}}"></script>
...
<script src="{{@TELERIK}}ui/formulario/plan_compra/js/simulador_compra_celdabtn.js?v={{rand(0,999999)}}"></script>
<!-- 5 En Cargar (Orden Obligatorio) -->
<script src="{{@TELERIK}}ui/formulario/plan_compra/js/simulador_compra_funciones.js?v={{rand(0,999999)}}"></script>
