			...
			for ($i = 1; $i <= $limite; $i++) {
				...
				$sql = "begin PLC_PKG_GENERAL.PRC_ADD_PLAN_COMPRA_COLOR_3" .
					...
					("('" . $cod_tempo . "'" .
						...
						"," . $rows[$i][$nom_columnas['Cod Color']] . "" .
						/*V_COD_PIRAMIX*/
						"," . plan_compra::get_codName($rows[$i][$nom_columnas['Piramide Mix']], plan_compra::list_piramidemix($f3)) . "" .
						/*V_PORCENTAJE*/
						",0" .
						/*V_UNIDADES*/
						...
						",'" . "" . "'" .
						/*V_COD_RANKVTA*/
						"," . plan_compra::get_codName($rows[$i][$nom_columnas['Ranking de venta']], plan_compra::list_rnk($f3)) . "" .
						/*V_DSCTO_OBJ*/
						",0" .
						/*V_DSCTO_PROM*/
						",0" .
		...
		public static function InsertHistoricaAssortment2($rows, $nom_columnas, $cod_tempo, $depto, $codMarca) {
			...
			$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_HIST_ASSORTMENT" .
				...
				("(" . $cod_tempo . "" .
					...
					/*V_NOMBRE_ESTILO*/
					",'" . utf8_encode($rows[$nom_columnas['Nombre Estilo']]) . "'" .
					/*V_ESTILO_CORTO*/
					",'" . utf8_encode($rows[$nom_columnas['Estilo Corto']]) . "'" .
					/*V_DESCRIPCION_ESTILO*/
					",'" . utf8_encode($rows[$nom_columnas['Descripcion Estilo']]) . "'" .
					/*V_COLOR*/
					...
					/*V_PAIS*/
					",'" . utf8_encode($rows[$nom_columnas['Pais']]) . "'" .
					/*V_FACTOR*/
					...
					/*V_VENTI*/
					"," . ($rows[$nom_columnas['VentI']] <> null ? ($rows[$nom_columnas['VentI']]) : 0) . "" .
					/*V_COD_OPCION*/
					",'" . $rows[$nom_columnas['Cod Opcion']] . "'" . ", :error, :data); end;");
		...
		public static function InsertPlanCompraAssorment2($rows, $nom_columnas, $cod_tempo, $depto, $login) {
			...
			$sql = "begin PLC_PKG_GENERAL.PRC_ADD_PLAN_COMPRA_COLOR_3" .
				...
				("('" . $cod_tempo . "'" .
					...
					",'" . $rows[$nom_columnas['Temporada']] . "'" .
					/*V_NOM_LINEA*/
					",'" . utf8_encode($rows[$nom_columnas['nom_linea']]) . "'" .
					/*V_NOM_SUBLINEA*/
					",'" . utf8_encode($rows[$nom_columnas['nom_sublinea']]) . "'" .
					/*V_NOM_MARCA*/
					",'" . utf8_encode($rows[$nom_columnas['nom_marca']]) . "'" .
					/*V_NOM_ESTILOVIDA*/
					",''" .
					/*V_NOM_CALIDAD*/
					",''" .
					...
					",'IMP'" .
					/*V_NOM_VIA*/
					",'" . utf8_encode($rows[$nom_columnas['Via']]) . "'" .
					/*V_NOM_PAIS*/
					",'" . utf8_encode($rows[$nom_columnas['Pais']]) . "'" .
					/*V_NOM_MONEDA*/
					",'USD'" .
					...
					/*V_N_CURVASXCAJAS*/
					"," . ($rows[$nom_columnas['N curvas por caja curvadas']] <> null ? ($rows[$nom_columnas['N curvas por caja curvadas']]) : 0) . ", :error, :data); end;");
			...
			foreach ($grupo_compra as $val) {
				...
				foreach ($data as $va1) {
					array_push($array1
						...
						, "COMPOSITION" => $va1[13]
						, "LINING" => $va1[14]
						, "TYPE OF FABRIC" => $va1[15]
						, "DETAILS" => $va1[16]
						, "DESCRIPCION INTERNET" => $va1[9]
		...
		Public static Function Export_asorment($tempo, $depto) {
			...
			foreach ($data as $va1) {
				$array1[] = array(
					...
					"Sublinea" => $va1[8],
					"Cod Sublinea" => $va1[9],
					"Codigo corporativo" => $va1[10],
					"Nombre Estilo" => $va1[11],
					"Estilo Corto" => $va1[12],
					"Descripcion Estilo" => $va1[13],
					"Cod Opcion" => $va1[101],
					"Color" => $va1[14],
					"Cod Color" => $va1[15],
					"Evento" => $va1[16],
					"Grupo de compra" => $va1[17],
					"Ventana Debut" => $va1[18],
					"Tipo exhibicion" => $va1[19],
					"Tipo Producto" => $va1[20],
					"Debut o Reorder" => $va1[21],
					"Temporada" => $va1[22],
					"Precio" => $va1[23],
					"Ranking de venta" => $va1[24],
					"Ciclo de Vida" => $va1[25],
					"Piramide Mix" => $va1[26],
					"Ratio compra" => $va1[27],
					"Factor amplificacion" => $va1[28],
					"Ratio compra final" => $va1[29],
					"Cluster" => $va1[30],
					"Formato" => $va1[31],
					"Compra Unidades Assortment" => $va1[32],
					"Compra Unidades final" => $va1[33],
					"Var%" => $va1[34],
					"Target USD" => $va1[35],
					"RFID USD" => $va1[36],
					"Via" => $va1[37],
					...
					"Curva8" => $va1[61],
					"Curva9" => $va1[62],
					"Validador Masterpack/Inner" => $va1[63],
					"Tipo de empaque" => $va1[64],
					"N curvas por caja curvadas" => $va1[65],
					"1_%" => $va1[66],
					"2_%" => $va1[67],
					"3_%" => $va1[68],
					"4_%" => $va1[69],
