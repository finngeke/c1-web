...
#region {*************Metodos Importar Assortment*************}
				...
				if ($rows[$i][$nom_columnas['Cod Dpto']] == $depto and
					...
					$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_HIST_ASSORTMENT" .
						...
						("(" . $cod_tempo . "" .
							...
							/*V_VENTANA_DEBUT*/
							",'" . $rows[$i][$nom_columnas['Ventana Debut']] . "'" .
							/*V_TIPO_EXHIBICION*/
							...
							/*V_PRECIO*/
							"," . ($rows[$i][$nom_columnas['Precio']] <> null ? ($rows[$i][$nom_columnas['Precio']]) : 0) . "" .
							/*V_RANKING_DE_VENTA*/
							",'" . $rows[$i][$nom_columnas['Ranking de venta']] . "'" .
							/*V_CICLO_DE_VIDA*/
							",'" . $rows[$i][$nom_columnas['Ciclo de Vida']] . "'" .
							/*V_PIRAMIDE_MIX*/
							",'" . $rows[$i][$nom_columnas['Piramide Mix']] . "'" .
							/*V_RATIO_COMPRA*/
							",'" . $rows[$i][$nom_columnas['Ratio compra']] . "'" .
							/*V_FACTOR_AMPLIFICACION*/
							",'" . $rows[$i][$nom_columnas['Factor amplificacion']] . "'" .
							/*V_RATIO_COMPRA_FINAL*/
							",'" . $rows[$i][$nom_columnas['Ratio compra final']] . "'" .
							/*V_CLUSTER_*/
							",'" . $rows[$i][$nom_columnas['Cluster']] . "'" .
							/*V_FORMATO*/
							",'" . $rows[$i][$nom_columnas['Formato']] . "'" .
							/*V_COMPRA_UNIDADES_ASSORTMENT*/
							"," . ($rows[$i][$nom_columnas['Compra Unidades Assortment']] <> null ? ($rows[$i][$nom_columnas['Compra Unidades Assortment']]) : 0) . "" .
							/*V_COMPRA_UNIDADES_FINAL*/
							"," . ($rows[$i][$nom_columnas['Compra Unidades final']] <> null ? ($rows[$i][$nom_columnas['Compra Unidades final']]) : 0) . "" .
							/*V_VAR_PORCE*/
							",'" . $rows[$i][$nom_columnas['Var%']] . "'" .
							/*V_TARGET_USD*/
							"," . ($rows[$i][$nom_columnas['Target USD']] <> null ? ($rows[$i][$nom_columnas['Target USD']]) : 0) . "" .
							/*V_RFID_USD*/
							"," . ($rows[$i][$nom_columnas['RFID USD']] <> null ? ($rows[$i][$nom_columnas['RFID USD']]) : 0) . "" .
							/*V_VIA*/
							",'" . $rows[$i][$nom_columnas['Via']] . "'" .
							/*V_PAIS*/
							",'" . $rows[$i][$nom_columnas['Pais']] . "'" .
							/*V_FACTOR*/
							"," . ($rows[$i][$nom_columnas['Factor']] <> null ? ($rows[$i][$nom_columnas['Factor']]) : 0) . "" .
							/*V_COSTO_TOTAL*/
							"," . ($rows[$i][$nom_columnas['Costo Total']] <> null ? ($rows[$i][$nom_columnas['Costo Total']]) : 0) . "" .
							/*V_RETAIL_TOTAL_SIN_IVA*/
							"," . ($rows[$i][$nom_columnas['Retail Total sin iva']] <> null ? ($rows[$i][$nom_columnas['Retail Total sin iva']]) : 0) . "" .
							/*V_MUP_COMPRA*/
							",'" . $rows[$i][$nom_columnas['MUP Compra']] . "'" .
							/*V_EXHIBICION*/
							",'" . $rows[$i][$nom_columnas['Exhibicion']] . "'" .
							/*V_TALLA1*/
							",'" . $rows[$i][$nom_columnas['Talla1']] . "'" .
							/*V_TALLA2*/
							",'" . $rows[$i][$nom_columnas['Talla2']] . "'" .
							/*V_TALLA3*/
							",'" . $rows[$i][$nom_columnas['Talla3']] . "'" .
							/*V_TALLA4*/
							",'" . $rows[$i][$nom_columnas['Talla4']] . "'" .
							/*V_TALLA5*/
							",'" . $rows[$i][$nom_columnas['Talla5']] . "'" .
							/*V_TALLA6*/
							",'" . $rows[$i][$nom_columnas['Talla6']] . "'" .
							/*V_TALLA7*/
							",'" . $rows[$i][$nom_columnas['Talla7']] . "'" .
							/*V_TALLA8*/
							",'" . $rows[$i][$nom_columnas['Talla8']] . "'" .
							/*V_TALLA9*/
							",'" . $rows[$i][$nom_columnas['Talla9']] . "'" .
							/*V_INNER*/
							",'" . ($rows[$i][$nom_columnas['Inner']] <> null ? ($rows[$i][$nom_columnas['Inner']]) : 0) . "'" .
							/*V_CURVA1*/
							"," . ($rows[$i][$nom_columnas['Curva1']] <> null ? ($rows[$i][$nom_columnas['Curva1']]) : 0) . "" .
							/*V_CURVA2*/
							"," . ($rows[$i][$nom_columnas['Curva2']] <> null ? ($rows[$i][$nom_columnas['Curva2']]) : 0) . "" .
							/*V_CURVA3*/
							"," . ($rows[$i][$nom_columnas['Curva3']] <> null ? ($rows[$i][$nom_columnas['Curva3']]) : 0) . "" .
							/*V_CURVA4*/
							"," . ($rows[$i][$nom_columnas['Curva4']] <> null ? ($rows[$i][$nom_columnas['Curva4']]) : 0) . "" .
							/*V_CURVA5*/
							"," . ($rows[$i][$nom_columnas['Curva5']] <> null ? ($rows[$i][$nom_columnas['Curva5']]) : 0) . "" .
							/*V_CURVA6*/
							"," . ($rows[$i][$nom_columnas['Curva6']] <> null ? ($rows[$i][$nom_columnas['Curva6']]) : 0) . "" .
							/*V_CURVA7*/
							"," . ($rows[$i][$nom_columnas['Curva7']] <> null ? ($rows[$i][$nom_columnas['Curva7']]) : 0) . "" .
							/*V_CURVA8*/
							"," . ($rows[$i][$nom_columnas['Curva8']] <> null ? ($rows[$i][$nom_columnas['Curva8']]) : 0) . "" .
							/*V_CURVA9*/
							"," . ($rows[$i][$nom_columnas['Curva9']] <> null ? ($rows[$i][$nom_columnas['Curva9']]) : 0) . "" .
							/*V_Validador_Masterpack_Inner*/
							",'" . $rows[$i][$nom_columnas['Validador Masterpack/Inner']] . "'" .
							/*V_TIPO_DE_EMPAQUE*/
							",'" . $rows[$i][$nom_columnas['Tipo de empaque']] . "'" .
							/*V_N_CURVAS_POR_CAJA_CURVADAS*/
							"," . ($rows[$i][$nom_columnas['N curvas por caja curvadas']] <> null ? ($rows[$i][$nom_columnas['N curvas por caja curvadas']]) : 0) . "" .
							/*V_UNO_POR*/
							",'" . $rows[$i][$nom_columnas['1_%']] . "'" .
							/*V_DOS_POR*/
							",'" . $rows[$i][$nom_columnas['2_%']] . "'" .
							/*V_TRES_POR*/
							",'" . $rows[$i][$nom_columnas['3_%']] . "'" .
							/*V_CUATRO_POR*/
							",'" . $rows[$i][$nom_columnas['4_%']] . "'" .
							/*V_CINCO_POR*/
							",'" . $rows[$i][$nom_columnas['5_%']] . "'" .
							/*V_SEIS_POR*/
							",'" . $rows[$i][$nom_columnas['6_%']] . "'" .
							/*V_SIETE_POR*/
							",'" . $rows[$i][$nom_columnas['7_%']] . "'" .
							/*V_OCHO_POR*/
							",'" . $rows[$i][$nom_columnas['8_%']] . "'" .
							/*V_NUEVE_POR*/
							",'" . $rows[$i][$nom_columnas['9_%']] . "'" .
							/*V_TIENDASA*/
							"," . ($rows[$i][$nom_columnas['TiendasA']] <> null ? ($rows[$i][$nom_columnas['TiendasA']]) : 0) . "" .
							/*V_TIENDASB*/
							"," . ($rows[$i][$nom_columnas['TiendasB']] <> null ? ($rows[$i][$nom_columnas['TiendasB']]) : 0) . "" .
							/*V_TIENDASC*/
							"," . ($rows[$i][$nom_columnas['TiendasC']] <> null ? ($rows[$i][$nom_columnas['TiendasC']]) : 0) . "" .
							/*V_TIENDASI*/
							"," . ($rows[$i][$nom_columnas['TiendasI']] <> null ? ($rows[$i][$nom_columnas['TiendasI']]) : 0) . "" .
							/*V_CLUSTERA*/
							"," . ($rows[$i][$nom_columnas['ClusterA']] <> null ? ($rows[$i][$nom_columnas['ClusterA']]) : 0) . "" .
							/*V_CLUSTERB*/
							"," . ($rows[$i][$nom_columnas['ClusterB']] <> null ? ($rows[$i][$nom_columnas['ClusterB']]) : 0) . "" .
							/*V_CLUSTERC*/
							"," . ($rows[$i][$nom_columnas['ClusterC']] <> null ? ($rows[$i][$nom_columnas['ClusterC']]) : 0) . "" .
							/*V_CLUSTERI*/
							"," . ($rows[$i][$nom_columnas['ClusterI']] <> null ? ($rows[$i][$nom_columnas['ClusterI']]) : 0) . "" .
							/*V_Size_1*/
							...
							/*V_VENTA*/
							"," . ($rows[$i][$nom_columnas['VentA']] <> null ? ($rows[$i][$nom_columnas['VentA']]) : 0) . "" .
							/*V_VENTB*/
							"," . ($rows[$i][$nom_columnas['VentB']] <> null ? ($rows[$i][$nom_columnas['VentB']]) : 0) . "" .
							/*V_VENTC*/
							"," . ($rows[$i][$nom_columnas['VentC']] <> null ? ($rows[$i][$nom_columnas['VentC']]) : 0) . "" .
							/*V_VENTD*/
							"," . ($rows[$i][$nom_columnas['VentD']] <> null ? ($rows[$i][$nom_columnas['VentD']]) : 0) . "" .
							/*V_VENTE*/
							"," . ($rows[$i][$nom_columnas['VentE']] <> null ? ($rows[$i][$nom_columnas['VentE']]) : 0) . "" .
							/*V_VENTF*/
							"," . ($rows[$i][$nom_columnas['VentF']] <> null ? ($rows[$i][$nom_columnas['VentF']]) : 0) . "" .
							/*V_VENTG*/
							"," . ($rows[$i][$nom_columnas['VentG']] <> null ? ($rows[$i][$nom_columnas['VentG']]) : 0) . "" .
							/*V_VENTH*/
							"," . ($rows[$i][$nom_columnas['VentH']] <> null ? ($rows[$i][$nom_columnas['VentH']]) : 0) . "" .
							/*V_VENTI*/
							"," . ($rows[$i][$nom_columnas['VentI']] <> null ? ($rows[$i][$nom_columnas['VentI']]) : 0) . "" . ", :error, :data); end;");
		...
		public static function InsertPlanCompraAssorment($rows, $limite, $nom_columnas, $cod_tempo, $depto, $login) {
			...
			for ($i = 1; $i <= $limite; $i++) {
				...
				$sql = "begin PLC_PKG_GENERAL.PRC_ADD_PLAN_COMPRA_COLOR_3" .
					...
					("('" . $cod_tempo . "'" .
						...
						"," . $rows[$i][$nom_columnas['Cod Color']] . "" .
						/*V_COD_PIRAMIX*/
						"," . plan_compra::get_codName($rows[$i][$nom_columnas['Piramide Mix']], plan_compra::list_piramidemix()) . "" .
						/*V_PORCENTAJE*/
						",0" .
						/*V_UNIDADES*/
						"," . $dtAjustada[3] . "" . /*-Unidades finales-*/
						/*V_USR_CRE*/
						",'" . $login . "'" .
						/*V_USR_MOD*/
						",'" . $login . "'" .
						/*V_SEM_INI*/
						",'" . plan_compra::SemanasIni_Fin('SemIni', $cod_vent, $cod_tempo, '', '') . "'" .
						/*V_SEM_FIN*/
						",'" . plan_compra::SemanasIni_Fin('SemFin', $cod_vent, $cod_tempo, plan_compra::get_codName($rows[$i][$nom_columnas['Ciclo de Vida']], plan_compra::list_ciclo_vida()), $rows[$i][$nom_columnas['Debut o Reorder']]) . "'" .
						/*V_CICLO*/
						",'" . plan_compra::getsemliq_cicloA('CicloA', $rows[$i][$nom_columnas['Ciclo de Vida']], $rows[$i][$nom_columnas['Debut o Reorder']]) . "'" .
						/*V_TIPO_CURVA*/
						",0" .
						/*V_NUM_EMB*/
						",0" .
						...
						",'" . "" . "'" .
						/*V_COD_RANKVTA*/
						"," . plan_compra::get_codName($rows[$i][$nom_columnas['Ranking de venta']], plan_compra::list_rnk()) . "" .
						/*V_DSCTO_OBJ*/
						",0" .
						/*V_DSCTO_PROM*/
						",0" .
						...
						",0" .
						/*V_GM*/
						"," . round((((($rows[$i][$nom_columnas['Precio']] / 1.19) - (plan_compra::getC_uni_final($rows[$i][$nom_columnas['Target USD']], $rfid, $rows[$i][$nom_columnas['Ventana Debut']], $cod_tempo, $depto, $cod_pais, $cod_via))) / ($rows[$i][$nom_columnas['Precio']] / 1.19)) * 100), 2) . "" .
						/*V_ID*/
						",0" .
						/*V_TIPO_DSCTO*/
						",0" .
						...
						",0.7" .
						/*V_SEMLIQ*/
						"," . plan_compra::getsemliq_cicloA('semLiq', $rows[$i][$nom_columnas['Ciclo de Vida']], $rows[$i][$nom_columnas['Debut o Reorder']]) . "" .
						/*V_COSTO_UNIT*/
						"," . ($rows[$i][$nom_columnas['Target USD']] + $rfid) . "" ./*-COSTO UNITARIO FINAL US$-*/
						/*V_COSTO_UNITH*/
						",0" .
						/*V_COSTO_TOT*/
						",0" . /*-TOTAL FOB US$-*/
						...
						",0" .
						/*V_COSTO_UNITS*/
						"," . plan_compra::getC_uni_final($rows[$i][$nom_columnas['Target USD']], $rfid, $rows[$i][$nom_columnas['Ventana Debut']]
							, $cod_tempo, $depto, $cod_pais, $cod_via) . "" ./*-COSTO UNITARIO FINAL PESOS-*/
						/*V_COSTO_TOTS*/
						"," . $Cos_Uni_Finl_Pesos . "" . /*-CALCULO COSTO TOTAL PESOS$-*/
						/*V_BOLSA*/
						",0" .
						/*V_ITEM_REF*/
						",0" .
						/*V_LIFE_CYCLE*/
						"," . plan_compra::get_codName($rows[$i][$nom_columnas['Ciclo de Vida']], plan_compra::list_ciclo_vida()) . "" .
						/*V_VENT_REAL*/
						",'" . $rows[$i][$nom_columnas['Ventana Debut']] . "'" .
						/*V_RETAIL*/
						"," . ROUND((($dtAjustada[3] * $rows[$i][$nom_columnas['Precio']]) / 1.19)) . "" .  /*-RETAIL-*/
						/*V_FORMATO*/
						",'" . $rows[$i][$nom_columnas['Formato']] . "'" .
						/*V_DEBUT_REODER*/
						",'" . $rows[$i][$nom_columnas['Debut o Reorder']] . "'" .
						...
						"," . $dtmstpack = plan_compra::get_mst_pack($depto, $rows[$i][$nom_columnas['Cod Linea']], $rows[$i][$nom_columnas['Cod Sublinea']]) . "" .
							/*V_MKUP*/
							"," . round(($rows[$i][$nom_columnas['Precio']] / 1.19) / (plan_compra::getC_uni_final($rows[$i][$nom_columnas['Target USD']], $rfid, $rows[$i][$nom_columnas['Ventana Debut']], $cod_tempo, $depto, $cod_pais, $cod_via)), 2) . "" .
							/*V_CODSKUPROVEEDOR*/
							",0" .
							/*V_GRUPO_COMPRA*/
							",'" . $rows[$i][$nom_columnas['Grupo de compra']] . "'" .
							...
							",0" .
							/*V_CST_TOTLTARGET*/
							"," . $Cos_Total_Target_us . "" ./*-COSTO TOTAL TARGET.-*/
							/*V_CANT_INNER*/
							"," . $dtAjustada[2] . "" ./*-N_CAJAS.-*/
							/*V_UNID_OPCION_INICIO*/
							"," . $rows[$i][$nom_columnas['Unidades']] . "" .
							/*V_UND_ASIG_INI*/
							"," . $dtAjustada[4] . "" . /*-Primera_Reparto.-*/
							/*V_DESTALLA*/
							",'" . $tallas . "'" .
							/*V_CURVATALLA*/
							",'" . $curva_reparto . "'" .
							...
							",0" .
							/*V_PORTALLA_1*/
							",'" . $dtAjustada[1] . "'" ./*-Porcentaje Ajustada-*/
							/*V_CURVAMIN*/
							...
							",0" .
							/*V_TEMP*/
							"," . plan_compra::get_codtemporadaseason($rows, $nom_columnas, $i) . "" .
							/*V_COLECCION*/
							",0" .
							/*V_COD_ESTILO_VIDA*/
							",0" .
							...
							",'" . $rows[$i][$nom_columnas['Temporada']] . "'" .
							/*V_NOM_LINEA*/
							",'" . plan_compra::get_NomJerarquia($dtjerarquia, $rows, $nom_columnas, $i, 1) . "'" .
							/*V_NOM_SUBLINEA*/
							",'" . plan_compra::get_NomJerarquia($dtjerarquia, $rows, $nom_columnas, $i, 2) . "'" .
							/*V_NOM_MARCA*/
							",'" . plan_compra::get_NomMarcas($dtmarcas, $rows, $nom_columnas, $i) . "'" .
							/*V_NOM_ESTILOVIDA*/
							",''" .
							/*V_NOM_CALIDAD*/
							",''" .
							...
							"," . $dtAjustada[0] . "" .
							/*V_TIPO_EMPAQUE*/
							",'" . trim(strtoupper($rows[$i][$nom_columnas['Tipo de empaque']])) . "'" .
							/*V_CURVA_COMPRA*/
							",0" .
							/*V_I*/
							"," . $dtclustercurva[3] . "" .
							...
							",'" . $rows[$i][$nom_columnas['Estilo Corto']] . "'" .
							/*V_N_CURVASXCAJAS*/
							"," . $rows[$i][$nom_columnas['N curvas por caja curvadas']] . ", :error, :data); end;");
				...
				$sql = "begin PLC_PKG_UTILS.PRC_ADD_PLAN_COMPRA_COLOR_CIC" .
					...
					("('" . $cod_tempo . "'" .
						...
						",0" .//FALTA CALCULO
						/*V_VTA_CDSCTO*/
						"," . round((($dtAjustada[3] * $rows[$i][$nom_columnas['Precio']]) / 1.19), 0) . "" .
						/*V_GM*/
						"," . round((((($rows[$i][$nom_columnas['Precio']] / 1.19) - (plan_compra::getC_uni_final($rows[$i][$nom_columnas['Target USD']], $rfid, $rows[$i][$nom_columnas['Ventana Debut']], $cod_tempo, $depto, $cod_pais, $cod_via))) / ($rows[$i][$nom_columnas['Precio']] / 1.19)) * 100), 2) . "" .
						/*V_PERIODO*/
						"," . plan_compra::get_codName($rows[$i][$nom_columnas['Ventana Debut']], plan_compra::list_ventanas($cod_tempo)) . "" .
						/*V_SEM_CORTA*/
						",0" .
						/*V_ID*/
						",0" .
				...
				$sql = "begin PLC_PKG_PRUEBA.PRC_ADD_PLAN_HISTORICO" .
					...
					("('" . $cod_tempo . "'" .
						...
						",'" . $rows[$i][$nom_columnas['Ventana Debut']] . "'" .
						/*V_NOM_COLOR*/
						",'" . $rows[$i][$nom_columnas['Color']] . "', :error, :data); end;");
				$data = \database::getInstancia()->getConsultaSP($sql, 2);
				$_error = explode("#", $data);
				if ($_error[0] == 1) {
					$_insert = false;
				...
				$_error = plan_compra::SaveAjuste_Compra(/*AJUSTE DE COMPRA*/
					$dtAjustada[8]
		...
		public static function list_rnk() {
			//275 proc
			//307 qa
			$sql = "SELECT C.ATR_COD_TECH_KEY AS CODIGO,UPPER(C.ATR_CODE_DESC)  DESCRIPCION"
				. " FROM   BASACDEE C"
				. " WHERE  C.ATR_HDR_TECH_KEY = 275"
				. " AND  atr_code not in ('12 MESES','1 MES','6 MESES','3 MESES')"
				. " ORDER BY C.ATR_CODE_DESC";
			$data = \database::getInstancia()->getFilas($sql);
			return $data;
		...
		public static function list_piramidemix() {
			//274 proc
			//306 qa
			$sql = "SELECT C.ATR_COD_TECH_KEY AS CODIGO,UPPER(C.ATR_CODE_DESC)  DESCRIPCION"
				. " FROM   BASACDEE C"
				. " WHERE  C.ATR_HDR_TECH_KEY = 274"
				. " AND atr_code not in ('12 MESES','1 MES','6 MESES','3 MESES')"
		...
		public static function AjustesPrimerReparto($por_Inicial, $unid_ini, $curva_reparto, $tallas, $rows, $nom_columnas, $cod_tempo, $depto, $marca, $DEBUT, $tipo_empaque, $N_CURVAS_CAJAS, $formato, $dtplanCompra, $mstpack, $id_for) {
			...
			IF ($DEBUT == "DEBUT") {
				//*-----------------curva de compra
				$insert = [];
				$por_Inicial = explode("-", trim($por_Inicial));
				$total = 0;
				...
				if ($tipo_empaque == "Curvado" or $tipo_empaque == "CURVADO") {
					...
					$n_CAJAS = $Curva_repartir / $N_CURVAS_CAJAS;
					$insert = [];
					foreach ($tallas2 as $vart) {
						array_push($insert, 0);
					}
		...
		public static function list_plan_compraxgrupo($tempo, $depto, $grupo) {
			...
			if (strtoupper($DEBUT) == "DEBUT" AND strtoupper($Tipo_empaque) == "CURVADO") {
				...
				foreach ($dtTabla as $val) {
					if ($key <> 0) {
						//columnas
						if ($key == 1) {
							$columnas = "Curva de Compra";
						} elseif ($key == 2) {
							$columnas = "Curva Primer Reparto";
						} elseif ($key == 3) {
							$columnas = "Diferencial";
						} elseif ($key == 4) {
							$columnas = "Total";
						} elseif ($key == 5) {
							$columnas = "Curva de compra Ajustada";
						}
						...
						$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_AJUSTES_COMPRA" .
							...
							("('" . $cod_tempo . "'" .
								...
								"," . $tallas3[8] . "" .
								/*V_TOTAL*/
								"," . ($key <> 5 ? ($val[$N_Columna]) : 0) . "" .
								/*V_TIPO_AJUSTE*/
								",'Ajuste de Compra', :error, :data); end;");
						$data = \database::getInstancia()->getConsultaSP($sql, 2);
						$_error = explode("#", $data);
						if ($_error[0] == 1) {
							$_insert = false;
				...
				foreach ($dtTablaCurvado as $val) {
					if ($key <> 0) {
						//columnas
						if ($key == 1) {
							$columnas = "Compra Total";
						} elseif ($key == 2) {
							$columnas = "1er Reparto";
						} elseif ($key == 3) {
							$columnas = "Curva 1er Reparto";
						} elseif ($key == 4) {
							$columnas = "Master Curvado";
						} elseif ($key == 5) {
							$columnas = "Curvas a repartir";
						} elseif ($key == 6) {
							$columnas = "N de Cajas";
						} elseif ($key == 7) {
							$columnas = "N de curvas x cajas";
						}
						$tallas3 = plan_compra::Division_tallas($tallas2, $val);
						$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_AJUSTES_COMPRA" .
							/*V_COD_TEMPORADA*/
				...
				foreach ($dtTablasSolidoCurvado as $val) {
					if ($key <> 0) {
						//columnas
						if ($key == 1) {
							$columnas = "Total Solido";
						} elseif ($key == 2) {
							$columnas = "N Cajas";
						} elseif ($key == 3) {
							$columnas = "Total Solido Ajustado";
						} elseif ($key == 4) {
							$columnas = "Master Pack";
						} elseif ($key == 5) {
							$columnas = "Total Unidades Final";
						} elseif ($key == 6) {
							$columnas = "Total N Cajas Final";
						} elseif ($key == 7) {
							$columnas = "Total Porcentajes Ajust Final";
						}
						$tallas3 = plan_compra::Division_tallas($tallas2, $val);
						$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_AJUSTES_COMPRA" .
							/*V_COD_TEMPORADA*/
					...
					if ($key <> 0) {
						...
						$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_AJUSTES_COMPRA" .
							...
							("('" . $cod_tempo . "'" .
								...
								"," . $val[$N_Columna] . "" .
								/*V_TIPO_AJUSTE*/
								",'Ajuste Master Pack', :error, :data); end;");
						$data = \database::getInstancia()->getConsultaSP($sql, 2);
						$_error = explode("#", $data);
						if ($_error[0] == 1) {
							$_insert = false;
...
#region {*************Metodos Importar Assortment v2*************}
		...
		public static function InsertHistoricaAssortment2($rows, $nom_columnas, $cod_tempo, $depto, $codMarca) {
			...
			$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_HIST_ASSORTMENT" .
				...
				("(" . $cod_tempo . "" .
					...
					",'" . $depto . "'" .
					/*V_DPTO*/
					",'" . $rows[$nom_columnas['Dpto']] . "'" .
					/*V_MARCA*/
					",'" . $rows[$nom_columnas['Marca']] . "'" .
					/*V_CODIGO_MARCA*/
					"," . $codMarca . "" .
					/*V_SEASON*/
					",'" . $rows[$nom_columnas['Season']] . "'" .
					/*V_LINEA*/
					",'" . $rows[$nom_columnas['Linea']] . "'" .
					/*V_COD_LINEA*/
					",'" . $rows[$nom_columnas['Cod Linea']] . "'" .
					/*V_SUBLINEA*/
					",'" . $rows[$nom_columnas['Sublinea']] . "'" .
					/*V_COD_SUBLINEA*/
					",'" . $rows[$nom_columnas['Cod Sublinea']] . "'" .
					/*V_CODIGO_CORPORATIVO*/
					",'" . $rows[$nom_columnas['Codigo corporativo']] . "'" .
					/*V_NOMBRE_ESTILO*/
					",'" . $rows[$nom_columnas['Nombre Estilo']] . "'" .
					/*V_ESTILO_CORTO*/
					",'" . $rows[$nom_columnas['Estilo Corto']] . "'" .
					/*V_DESCRIPCION_ESTILO*/
					",'" . $rows[$nom_columnas['Descripcion Estilo']] . "'" .
					/*V_COLOR*/
					",'" . $rows[$nom_columnas['Color']] . "'" .
					/*V_COD_COLOR*/
					"," . $rows[$nom_columnas['Cod Color']] . "" .
					/*V_EVENTO*/
					",'" . $rows[$nom_columnas['Evento']] . "'" .
					/*V_GRUPO_DE_COMPRA*/
					",'" . $rows[$nom_columnas['Grupo de compra']] . "'" .
					/*V_VENTANA_DEBUT*/
					",'" . $rows[$nom_columnas['Ventana Debut']] . "'" .
					/*V_TIPO_EXHIBICION*/
					",'" . $rows[$nom_columnas['Tipo exhibicion']] . "'" .
					/*V_TIPO_PRODUCTO*/
					",'" . $rows[$nom_columnas['Tipo Producto']] . "'" .
					/*V_DEBUT_O_REORDER*/
					",'" . $rows[$nom_columnas['Debut o Reorder']] . "'" .
					/*V_TEMPORADA*/
					",'" . $rows[$nom_columnas['Temporada']] . "'" .
					/*V_PRECIO*/
					"," . ($rows[$nom_columnas['Precio']] <> null ? ($rows[$nom_columnas['Precio']]) : 0) . "" .
					/*V_RANKING_DE_VENTA*/
					",'" . $rows[$nom_columnas['Ranking de venta']] . "'" .
					/*V_CICLO_DE_VIDA*/
					",'" . $rows[$nom_columnas['Ciclo de Vida']] . "'" .
					/*V_PIRAMIDE_MIX*/
					",'" . $rows[$nom_columnas['Piramide Mix']] . "'" .
					/*V_RATIO_COMPRA*/
					",'" . $rows[$nom_columnas['Ratio compra']] . "'" .
					/*V_FACTOR_AMPLIFICACION*/
					",'" . $rows[$nom_columnas['Factor amplificacion']] . "'" .
					/*V_RATIO_COMPRA_FINAL*/
					",'" . $rows[$nom_columnas['Ratio compra final']] . "'" .
					/*V_CLUSTER_*/
					",'" . $rows[$nom_columnas['Cluster']] . "'" .
					/*V_FORMATO*/
					",'" . $rows[$nom_columnas['Formato']] . "'" .
					/*V_COMPRA_UNIDADES_ASSORTMENT*/
					"," . ($rows[$nom_columnas['Compra Unidades Assortment']] <> null ? ($rows[$nom_columnas['Compra Unidades Assortment']]) : 0) . "" .
					/*V_COMPRA_UNIDADES_FINAL*/
					"," . ($rows[$nom_columnas['Compra Unidades final']] <> null ? ($rows[$nom_columnas['Compra Unidades final']]) : 0) . "" .
					/*V_VAR_PORCE*/
					",'" . $rows[$nom_columnas['Var%']] . "'" .
					/*V_TARGET_USD*/
					"," . ($rows[$nom_columnas['Target USD']] <> null ? ($rows[$nom_columnas['Target USD']]) : 0) . "" .
					/*V_RFID_USD*/
					"," . ($rows[$nom_columnas['RFID USD']] <> null ? ($rows[$nom_columnas['RFID USD']]) : 0) . "" .
					/*V_VIA*/
					",'" . $rows[$nom_columnas['Via']] . "'" .
					/*V_PAIS*/
					",'" . $rows[$nom_columnas['Pais']] . "'" .
					/*V_FACTOR*/
					"," . ($rows[$nom_columnas['Factor']] <> null ? ($rows[$nom_columnas['Factor']]) : 0) . "" .
					/*V_COSTO_TOTAL*/
					"," . ($rows[$nom_columnas['Costo Total']] <> null ? ($rows[$nom_columnas['Costo Total']]) : 0) . "" .
					/*V_RETAIL_TOTAL_SIN_IVA*/
					"," . ($rows[$nom_columnas['Retail Total sin iva']] <> null ? ($rows[$nom_columnas['Retail Total sin iva']]) : 0) . "" .
					/*V_MUP_COMPRA*/
					",'" . $rows[$nom_columnas['MUP Compra']] . "'" .
					/*V_EXHIBICION*/
					",'" . $rows[$nom_columnas['Exhibicion']] . "'" .
					/*V_TALLA1*/
					",'" . $rows[$nom_columnas['Talla1']] . "'" .
					/*V_TALLA2*/
					",'" . $rows[$nom_columnas['Talla2']] . "'" .
					/*V_TALLA3*/
					",'" . $rows[$nom_columnas['Talla3']] . "'" .
					/*V_TALLA4*/
					",'" . $rows[$nom_columnas['Talla4']] . "'" .
					/*V_TALLA5*/
					",'" . $rows[$nom_columnas['Talla5']] . "'" .
					/*V_TALLA6*/
					",'" . $rows[$nom_columnas['Talla6']] . "'" .
					/*V_TALLA7*/
					",'" . $rows[$nom_columnas['Talla7']] . "'" .
					/*V_TALLA8*/
					",'" . $rows[$nom_columnas['Talla8']] . "'" .
					/*V_TALLA9*/
					",'" . $rows[$nom_columnas['Talla9']] . "'" .
					/*V_INNER*/
					",'" . ($rows[$nom_columnas['Inner']] <> null ? ($rows[$nom_columnas['Inner']]) : 0) . "'" .
					/*V_CURVA1*/
					"," . ($rows[$nom_columnas['Curva1']] <> null ? ($rows[$nom_columnas['Curva1']]) : 0) . "" .
					/*V_CURVA2*/
					"," . ($rows[$nom_columnas['Curva2']] <> null ? ($rows[$nom_columnas['Curva2']]) : 0) . "" .
					/*V_CURVA3*/
					"," . ($rows[$nom_columnas['Curva3']] <> null ? ($rows[$nom_columnas['Curva3']]) : 0) . "" .
					/*V_CURVA4*/
					"," . ($rows[$nom_columnas['Curva4']] <> null ? ($rows[$nom_columnas['Curva4']]) : 0) . "" .
					/*V_CURVA5*/
					"," . ($rows[$nom_columnas['Curva5']] <> null ? ($rows[$nom_columnas['Curva5']]) : 0) . "" .
					/*V_CURVA6*/
					"," . ($rows[$nom_columnas['Curva6']] <> null ? ($rows[$nom_columnas['Curva6']]) : 0) . "" .
					/*V_CURVA7*/
					"," . ($rows[$nom_columnas['Curva7']] <> null ? ($rows[$nom_columnas['Curva7']]) : 0) . "" .
					/*V_CURVA8*/
					"," . ($rows[$nom_columnas['Curva8']] <> null ? ($rows[$nom_columnas['Curva8']]) : 0) . "" .
					/*V_CURVA9*/
					"," . ($rows[$nom_columnas['Curva9']] <> null ? ($rows[$nom_columnas['Curva9']]) : 0) . "" .
					/*V_Validador_Masterpack_Inner*/
					",'" . $rows[$nom_columnas['Validador Masterpack/Inner']] . "'" .
					/*V_TIPO_DE_EMPAQUE*/
					",'" . $rows[$nom_columnas['Tipo de empaque']] . "'" .
					/*V_N_CURVAS_POR_CAJA_CURVADAS*/
					"," . ($rows[$nom_columnas['N curvas por caja curvadas']] <> null ? ($rows[$nom_columnas['N curvas por caja curvadas']]) : 0) . "" .
					/*V_UNO_POR*/
					",'" . $rows[$nom_columnas['1_%']] . "'" .
					/*V_DOS_POR*/
					",'" . $rows[$nom_columnas['2_%']] . "'" .
					/*V_TRES_POR*/
					",'" . $rows[$nom_columnas['3_%']] . "'" .
					/*V_CUATRO_POR*/
					",'" . $rows[$nom_columnas['4_%']] . "'" .
					/*V_CINCO_POR*/
					",'" . $rows[$nom_columnas['5_%']] . "'" .
					/*V_SEIS_POR*/
					",'" . $rows[$nom_columnas['6_%']] . "'" .
					/*V_SIETE_POR*/
					",'" . $rows[$nom_columnas['7_%']] . "'" .
					/*V_OCHO_POR*/
					",'" . $rows[$nom_columnas['8_%']] . "'" .
					/*V_NUEVE_POR*/
					",'" . $rows[$nom_columnas['9_%']] . "'" .
					/*V_TIENDASA*/
					"," . ($rows[$nom_columnas['TiendasA']] <> null ? ($rows[$nom_columnas['TiendasA']]) : 0) . "" .
					/*V_TIENDASB*/
					"," . ($rows[$nom_columnas['TiendasB']] <> null ? ($rows[$nom_columnas['TiendasB']]) : 0) . "" .
					/*V_TIENDASC*/
					"," . ($rows[$nom_columnas['TiendasC']] <> null ? ($rows[$nom_columnas['TiendasC']]) : 0) . "" .
					/*V_TIENDASI*/
					"," . ($rows[$nom_columnas['TiendasI']] <> null ? ($rows[$nom_columnas['TiendasI']]) : 0) . "" .
					/*V_CLUSTERA*/
					"," . ($rows[$nom_columnas['ClusterA']] <> null ? ($rows[$nom_columnas['ClusterA']]) : 0) . "" .
					/*V_CLUSTERB*/
					"," . ($rows[$nom_columnas['ClusterB']] <> null ? ($rows[$nom_columnas['ClusterB']]) : 0) . "" .
					/*V_CLUSTERC*/
					"," . ($rows[$nom_columnas['ClusterC']] <> null ? ($rows[$nom_columnas['ClusterC']]) : 0) . "" .
					/*V_CLUSTERI*/
					"," . ($rows[$nom_columnas['ClusterI']] <> null ? ($rows[$nom_columnas['ClusterI']]) : 0) . "" .
					/*V_Size_1*/
					",'" . $rows[$nom_columnas['Size%1']] . "'" .
					/*V_Size_2*/
					",'" . $rows[$nom_columnas['Size%2']] . "'" .
					/*V_Size_3*/
					",'" . $rows[$nom_columnas['Size%3']] . "'" .
					/*V_Size_4*/
					",'" . $rows[$nom_columnas['Size%4']] . "'" .
					/*V_Size_5*/
					",'" . $rows[$nom_columnas['Size%5']] . "'" .
					/*V_Size_6*/
					",'" . $rows[$nom_columnas['Size%6']] . "'" .
					/*V_Size_7*/
					",'" . $rows[$nom_columnas['Size%7']] . "'" .
					/*V_Size_8*/
					",'" . $rows[$nom_columnas['Size%8']] . "'" .
					/*V_Size_9*/
					",'" . $rows[$nom_columnas['Size%9']] . "'" .
					/*V_VENTA*/
					"," . ($rows[$nom_columnas['VentA']] <> null ? ($rows[$nom_columnas['VentA']]) : 0) . "" .
					/*V_VENTB*/
					"," . ($rows[$nom_columnas['VentB']] <> null ? ($rows[$nom_columnas['VentB']]) : 0) . "" .
					/*V_VENTC*/
					"," . ($rows[$nom_columnas['VentC']] <> null ? ($rows[$nom_columnas['VentC']]) : 0) . "" .
					/*V_VENTD*/
					"," . ($rows[$nom_columnas['VentD']] <> null ? ($rows[$nom_columnas['VentD']]) : 0) . "" .
					/*V_VENTE*/
					"," . ($rows[$nom_columnas['VentE']] <> null ? ($rows[$nom_columnas['VentE']]) : 0) . "" .
					/*V_VENTF*/
					"," . ($rows[$nom_columnas['VentF']] <> null ? ($rows[$nom_columnas['VentF']]) : 0) . "" .
					/*V_VENTG*/
					"," . ($rows[$nom_columnas['VentG']] <> null ? ($rows[$nom_columnas['VentG']]) : 0) . "" .
					/*V_VENTH*/
					"," . ($rows[$nom_columnas['VentH']] <> null ? ($rows[$nom_columnas['VentH']]) : 0) . "" .
					/*V_VENTI*/
					"," . ($rows[$nom_columnas['VentI']] <> null ? ($rows[$nom_columnas['VentI']]) : 0) . "" . ", :error, :data); end;");
		...
		public static function InsertPlanCompraAssorment2($rows, $nom_columnas, $cod_tempo, $depto, $login) {
			...
			$sql = "begin PLC_PKG_GENERAL.PRC_ADD_PLAN_COMPRA_COLOR_3" .
				...
				("('" . $cod_tempo . "'" .
					...
					"," . $rows[$nom_columnas['Cod Color']] . "" .
					/*V_COD_PIRAMIX*/
					"," . $rows[$nom_columnas['cod_piramidemix']] . "" .
					/*V_PORCENTAJE*/
					",0" .
					/*V_UNIDADES*/
					"," . $rows[$nom_columnas['und_finales']] . "" . /*-Unidades finales-*/
					/*V_USR_CRE*/
					",'" . $login . "'" .
					/*V_USR_MOD*/
					",'" . $login . "'" .
					/*V_SEM_INI*/
					",'" . $rows[$nom_columnas['Sem_ini']] . "'" .
					/*V_SEM_FIN*/
					",'" . $rows[$nom_columnas['sem_fin']] . "'" .
					/*V_CICLO*/
					",'" . $rows[$nom_columnas['ciclo']] . "'" .
					/*V_TIPO_CURVA*/
					",0" .
					/*V_NUM_EMB*/
					",0" .
					...
					",'" . $rows[$nom_columnas['Cluster']] . "'" .
					/*V_TDAS*/
					"," . $rows[$nom_columnas['n_tdas']] . "" .//falto el array numero de tiendas
					/*V_UND_ASIG*/
					",0" .
					/*V_ROT*/
					"," . $rows[$nom_columnas['tdas']] . "" ./*%tienda*/
					/*V_TIPO_CICLO*/
					",0" .
					/*V_INDICE*/
					",0" .
					/*V_GM*/
					"," . $rows[$nom_columnas['GM']] . "" .
					/*V_ID*/
					",0" .
					/*V_TIPO_DSCTO*/
					",0" .
					...
					",0" .
					/*V_VENT_EMB*/
					"," . $rows[$nom_columnas['cod_vent']] . "" .
					/*V_AGOT_OBJ*/
					",0.7" .
					/*V_SEMLIQ*/
					"," . $rows[$nom_columnas['semliq']] . "" .
					/*V_COSTO_UNIT*/
					"," . $rows[$nom_columnas['cos_uni_finalUS']] . "" ./*-COSTO UNITARIO FINAL US$-*/
					/*V_COSTO_UNITH*/
					",0" .
					/*V_COSTO_TOT*/
					",0" . /*-TOTAL FOB US$-*/
					...
					",0" .
					/*V_COSTO_UNITS*/
					"," . $rows[$nom_columnas['cos_uni_final$']] . "" ./*-COSTO UNITARIO FINAL PESOS-*/
					/*V_COSTO_TOTS*/
					"," . $rows[$nom_columnas['cos_total_$']] . "" . /*-CALCULO COSTO TOTAL PESOS$-*/
					/*V_BOLSA*/
					",0" .
					/*V_ITEM_REF*/
					",0" .
					/*V_LIFE_CYCLE*/
					"," . $rows[$nom_columnas['cod_ciclo_vida']] . "" .
					/*V_VENT_REAL*/
					",'" . $rows[$nom_columnas['Ventana Debut']] . "'" .
					/*V_RETAIL*/
					"," . $rows[$nom_columnas['cos_retail']] . "" .  /*-RETAIL-*/
					/*V_FORMATO*/
					",'" . $rows[$nom_columnas['Formato']] . "'" .
					/*V_DEBUT_REODER*/
					",'" . $rows[$nom_columnas['Debut o Reorder']] . "'" .
					...
					",'" . $rows[$nom_columnas['Codigo corporativo']] . "'" .
					/*V_MTR_PACK*/
					"," . $rows[$nom_columnas['mst_pack']] . "" .
					/*V_MKUP*/
					"," . $rows[$nom_columnas['mkup']] . "" .
					/*V_CODSKUPROVEEDOR*/
					",0" .
					/*V_GRUPO_COMPRA*/
					",'" . $rows[$nom_columnas['Grupo de compra']] . "'" .
					...
					",1" .
					/*V_VIA*/
					"," . $rows[$nom_columnas['cod_via']] . "" .
					/*V_PAIS*/
					"," . $rows[$nom_columnas['cod_pais']] . "" .
					/*V_VIAJE*/
					",0" .
					/*V_CST_TOTLTARGET*/
					"," . $rows[$nom_columnas['cos_total_target']] . "" ./*-COSTO TOTAL TARGET.-*/
					/*V_CANT_INNER*/
					"," . $rows[$nom_columnas['n_cajas']] . "" ./*-N_CAJAS.-*/
					/*V_UNID_OPCION_INICIO*/
					"," . $rows[$nom_columnas['Unidades']] . "" .
					/*V_UND_ASIG_INI*/
					"," . $rows[$nom_columnas['primer_reparto']] . "" . /*-Primera_Reparto.-*/
					/*V_DESTALLA*/
					",'" . $rows[$nom_columnas['tallas']] . "'" .
					/*V_CURVATALLA*/
					",'" . $rows[$nom_columnas['curva_reparto']] . "'" .
					/*V_PORTALLA*/
					",0" .
					/*V_PORTALLA_1*/
					",'" . $rows[$nom_columnas['porcent_ajust']] . "'" ./*-Porcentaje Ajustada-*/
					/*V_CURVAMIN*/
					"," . $rows[$nom_columnas['Inner']] . "" .
					/*V_DIST*/
					",0" .
					/*V_COMPOSICION*/
					",0" .
					/*V_TEMP*/
					"," . $rows[$nom_columnas['cod_temp']] . "" .
					/*V_COLECCION*/
					",0" .
					/*V_COD_ESTILO_VIDA*/
					",0" .
					...
					",0" .
					/*V_A*/
					"," . $rows[$nom_columnas['ClusterA']] . "" .
					/*V_B*/
					"," . $rows[$nom_columnas['ClusterB']] . "" .
					/*V_C*/
					"," . $rows[$nom_columnas['ClusterC']] . "" .
					/*V_DIFER_REPARTO*/
					"," . $rows[$nom_columnas['diferencia']] . "" ./*-DIFERENCIA-*/
					/*V_ID_COLOR3*/
					"," . $rows[$nom_columnas['id_color3']] . "" .
					/*V_COD_TIP_MON*/
					"," . 2 . "" .
					/*V_COD_MARCA*/
					"," . $rows[$nom_columnas['Codigo Marca']] . "" .
					/*V_FACTOR_EST*/
					",0" .
					/*V_NOM_GRUPOCOMPRA*/
					",'" . $rows[$nom_columnas['Grupo de compra']] . "'" .
					...
					",'" . $rows[$nom_columnas['Temporada']] . "'" .
					/*V_NOM_LINEA*/
					",'" . $rows[$nom_columnas['nom_linea']] . "'" .
					/*V_NOM_SUBLINEA*/
					",'" . $rows[$nom_columnas['nom_sublinea']] . "'" .
					/*V_NOM_MARCA*/
					",'" . $rows[$nom_columnas['nom_marca']] . "'" .
					/*V_NOM_ESTILOVIDA*/
					",''" .
					/*V_NOM_CALIDAD*/
					",''" .
					...
					",0" .
					/*V_PORCEN_T1*/
					",'" . $rows[$nom_columnas['porcent_1']] . "'" .
					/*V_PORCEN_T2*/
					",'" . $rows[$nom_columnas['porcent_2']] . "'" .
					/*V_PORCEN_T3*/
					",'" . $rows[$nom_columnas['porcent_3']] . "'" .
					/*V_PORCEN_T4*/
					",'" . $rows[$nom_columnas['porcent_4']] . "'" .
					/*V_PORCEN_T5*/
					",'" . $rows[$nom_columnas['porcent_5']] . "'" .
					/*V_PORCEN_T6*/
					",'" . $rows[$nom_columnas['porcent_6']] . "'" .
					/*V_PORCEN_T7*/
					",'" . $rows[$nom_columnas['porcent_7']] . "'" .
					/*V_PORCEN_T8*/
					",'" . $rows[$nom_columnas['porcent_8']] . "'" .
					/*V_PORCEN_T9*/
					",'" . $rows[$nom_columnas['porcent_9']] . "'" .
					/*V_PORCEN_T10*/
					",0" .
					/*V_PORCEN_T11*/
					",0" .
					...
					",0" .
					/*V_CANT_T1*/
					"," . $rows[$nom_columnas['cant_1']] . "" .
					/*V_CANT_T2*/
					"," . $rows[$nom_columnas['cant_2']] . "" .
					/*V_CANT_T3*/
					"," . $rows[$nom_columnas['cant_3']] . "" .
					/*V_CANT_T4*/
					"," . $rows[$nom_columnas['cant_4']] . "" .
					/*V_CANT_T5*/
					"," . $rows[$nom_columnas['cant_5']] . "" .
					/*V_CANT_T6*/
					"," . $rows[$nom_columnas['cant_6']] . "" .
					/*V_CANT_T7*/
					"," . $rows[$nom_columnas['cant_7']] . "" .
					/*V_CANT_T8*/
					"," . $rows[$nom_columnas['cant_8']] . "" .
					/*V_CANT_T9*/
					"," . $rows[$nom_columnas['cant_9']] . "" .
					/*V_CANT_T10*/
					",0" .
					/*V_CANT_T11*/
					",0" .
					...
					",0" .
					/*V_PORTALLA_1_INI*/
					",'" . $rows[$nom_columnas['porcent_ini']] . "'" .
					/*V_OPCION_AJUSTADO*/
					"," . $rows[$nom_columnas['opcion_ajus']] . "" .
					/*V_TIPO_EMPAQUE*/
					",'" . trim(strtoupper($rows[$nom_columnas['Tipo de empaque']])) . "'" .
					/*V_CURVA_COMPRA*/
					",0" .
					/*V_I*/
					"," . $rows[$nom_columnas['ClusterI']] . "" .
					/*V_INTERNET_DESCRIPTION*/
					",''" .
					/*V_COSTO_RFID*/
					"," . $rows[$nom_columnas['RFID USD']] . "" .
					/*V_ERROR_PI*/
					",''" .
					/*V_SHORT_NAME*/
					",'" . $rows[$nom_columnas['Estilo Corto']] . "'" .
					/*V_N_CURVASXCAJAS*/
					"," . $rows[$nom_columnas['N curvas por caja curvadas']] . ", :error, :data); end;");
			...
			if ($_insert <> false) {
				$sql = "begin PLC_PKG_UTILS.PRC_ADD_PLAN_COMPRA_COLOR_CIC" .
					...
					("('" . $cod_tempo . "'" .
						...
						",0" .
						/*V_COSTO*/
						"," . $rows[$nom_columnas['cos_total_$']] . "" .
						/*V_VTA_CDSCTO*/
						"," . $rows[$nom_columnas['cos_retail']] . "" .
						/*V_GM*/
						"," . $rows[$nom_columnas['GM']] . "" .
						/*V_PERIODO*/
						"," . $rows[$nom_columnas['cod_vent']] . "" .
						...
						",0" .
						/*V_ID_COLOR3*/
						"," . $rows[$nom_columnas['id_color3']] . ", :error, :data); end;");
			...
			if ($_insert <> false) {
				$sql = "begin PLC_PKG_PRUEBA.PRC_ADD_PLAN_HISTORICO" .
					...
					("('" . $cod_tempo . "'" .
						...
						",'" . $rows[$nom_columnas['Ventana Debut']] . "'" .
						/*V_NOM_COLOR*/
						",'" . $rows[$nom_columnas['Color']] . "', :error, :data); end;");
				$data = \database::getInstancia()->getConsultaSP($sql, 2);
				$_error = explode("#", $data);
				if ($_error[0] == 1) {
					$_insert = false;
		...
		public static function ImpAssorCalculos($rows, $nom_columnas, $cod_tempo, $depto, $login, $dtjerarquia) {
			$_error = "";
			$_v = 0;
			$_Array = [];
			array_push($_Array, $nom_columnas);
			$_i = 0;
			$maxid = 0;
			$logAjustes = [];
			$key = 0;
				...
				if ($_i > 1) { //fila 1 es la cabesera
					...
					array_push($_Array
						...
						, $val2[$nom_columnas["Unidades"]]
							/*piramide mix*/, plan_compra::get_codName($val2[$nom_columnas['Piramide Mix']], plan_compra::list_piramidemix())
							...
							/*COD_RANKVTA*/, plan_compra::get_codName($val2[$nom_columnas['Ranking de venta']], plan_compra::list_rnk())
							/*tdas*/, $dtAjustada[5]
			...
			$key4 = 0;
			$logInsert = "";
			$count = count($logAjustes);
			foreach ($logAjustes as $val4) {
				$key4++;
				if ($count == $key4) {
...
#region {*************Metodos Importar BMT*************}
		...
		public static function listar_plan_compraPorID($cod_tempo, $depto, $id_colo3) {
			
			$sql = "select VENT_EMB,NOM_VENTANA,VENTANA_LLEGADA,TIPO_EMPAQUE,PORTALLA_1_INI,PORTALLA_1
              ...
              ,CICLO,SEMLIQ,ALIAS_PROV,CURVATALLA,FORMATO,A ClusterA,B ClusterB,C ClusterC,I ClusterI,N_CURVASXCAJAS,B.MSTPACK
		...
		public static function Calculo_DebutReorder($rows, $limite, $nom_columnas) {
			...
			for ($i = 1; $i <= $limite; $i++) {
				...
				if ($_exite <> true) {
					...
					$dtorderby = [];
					$count = count($dtGrupo) - 1;//ordernar grupo
			...
			for ($i = 1; $i <= $limite; $i++) {
				...
				$sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_HIS_IMPORT_BMT" .
					...
					("('" . $rows[$i][$nom_columnas['PURCHASE GROUP']] . "'" .
						...
						/*v_before_meeting_remarks*/
						",'" . $rows[$i][$nom_columnas['BEFORE MEETING REMARKS']] . "'" .
						/*v_after_meeting_remarks*/
						...
						/*v_cost_last_purchase*/
						",'" . $rows[$i][$nom_columnas['COST LAST PURCHASE']] . "'" .
						/*v_vendor_last_purchase*/
						...
						/*v_id_color3*/
						"," . $rows[$i][$nom_columnas['ID C1']] . ", :error, :data); end;");
				$data = \database::getInstancia()->getConsultaSP($sql, 2);
			...
			for ($i = 1; $i <= $limite; $i++) {
				...
				$sql = "begin PLC_PKG_DESARROLLO.PRC_UPDATE_PLAN_COMPRA_COLOR_3" .
					...
					("('" . $cod_tempo . "'" .
						...
						/*V_UNID_OPCION_INICIO*/
						"," . $rows[$i][$nom_columnas['TOTAL QUANTITY CL']] . "" .
						/*V_UNID_OPCION_AJUSTADA*/
						"," . $dtAjustada[0] . "" .
						/*V_UNIDADES*/
						"," . $dtAjustada[3] . "" .//unidades
						/*V_CANT_INNER*/
						"," . $dtAjustada[2] . "" ./*-N_CAJAS.-*/
						/*V_UND_ASIG_INI*/
						"," . $dtAjustada[4] . "" ./*-Primera_Reparto.-*/
						...
						",'" . $rows[$i][$nom_columnas['COUNTRY OF ORIGIN']] . "'" .
						/*V_MKUP*/
						"," . round(($rows[$i][$nom_columnas['RETAIL PRICE']] / 1.19) / $Cos_Uni_Finl_Pesos, 2) . "" .
						/*V_PRECIO_BLANCO*/
						"," . $rows[$i][$nom_columnas['RETAIL PRICE']] . "" .
						/*V_GM*/
						"," . round((($rows[$i][$nom_columnas['RETAIL PRICE']] / 1.19) - $Cos_Uni_Finl_Pesos) / ($rows[$i][$nom_columnas['RETAIL PRICE']] / 1.19) * 100, 2) . "" .
						/*V_COSTO_FOB*/
						"," . $rows[$i][$nom_columnas['FINAL COST']] . "" .
						/*V_COSTO_INSP*/
						"," . $rows[$i][$nom_columnas['INSPECTION COST']] . "" .
						...
						"," . $Cos_Uni_Finl_Pesos . "" .
						/*V_COSTO_TOT*/
						"," . $Cos_Uni_Finl_US * $dtAjustada[3] . "" .
						/*V_COSTO_TOTS*/
						"," . $Cos_Uni_Finl_Pesos * $dtAjustada[3] . "" .
						/*V_RETAIL*/
						"," . round(($rows[$i][$nom_columnas['RETAIL PRICE']] * $dtAjustada[3]) / 1.19) . "" .
						/*V_DEBUT_REODER*/
						",'" . $rows[$i][$nom_columnas['REORDER']] . "'" .
						/*V_SEM_INI*/
						",'" . plan_compra::SemanasIni_Fin('SemIni', $cod_vent, $cod_tempo, '', '') . "'" .
						/*V_SEM_FIN*/
						",'" . plan_compra::SemanasIni_Fin('SemFin', $cod_vent, $cod_tempo, plan_compra::get_codName($rows[$i][$nom_columnas['LIFE CICLE']], plan_compra::list_ciclo_vida()), $rows[$i][$nom_columnas['REORDER']]) . "'" .
						/*V_CICLO*/
						",'" . plan_compra::getsemliq_cicloA('CicloA', $rows[$i][$nom_columnas['LIFE CICLE']], $rows[$i][$nom_columnas['REORDER']]) . "'" .
						/*V_SEMLIQ*/
						"," . plan_compra::getsemliq_cicloA('semLiq', $rows[$i][$nom_columnas['LIFE CICLE']], $rows[$i][$nom_columnas['REORDER']]) . "" .
						/*V_ALIAS_PROV*/
						",'" . $rows[$i][$nom_columnas['VENDOR NICK NAME']] . "'" .
						/*V_PORCEN_T1*/
						",'" . $dtdiviporcent[0] . "'" .
						...
						"," . $dtdivicantidad[7] . "" .
						/*V_CANT_T9*/
						"," . $dtdivicantidad[8] . "" . ", :error, :data); end;");
		...
		public static function AjustesPrimerRepartobmt($por_Inicial, $unid_ini, $curva_reparto, $tallas, $rows
			...
			IF ($DEBUT == "DEBUT") {
				...
				$total = 0;
				foreach ($por_Inicial as $var) {
					$total += round((($var * $unid_ini)));
					array_push($insert, round((($var * $unid_ini))));
				}
				array_push($insert, $total);
				array_push($dtTabla, $insert);
				...
				if ($tipo_empaque == "Curvado" or $tipo_empaque == "CURVADO") {
					...
					$total = 0;
					foreach ($por_ajust as $var) {
						$total += round((($var * $unid_ajustas)));
						array_push($insert, round((($var * $unid_ajustas))));
					}
					array_push($insert, $total);
					array_push($dtTablasolidoFULL, $insert);
		...
		Public static Function ExportBMT($tempo, $depto, $grupo_compra) {
			...
			foreach ($grupo_compra as $val) {
				...
				foreach ($data as $va1) {
					array_push($array1
						, array("ID C1" => $va1[0]
						, "PURCHASE GROUP" => $va1[1]
						, "CORPORATE BUYER NAME" => $va1[2]
						, "DISIGNER NAME" => $va1[3]
						, "PI SEASON" => $va1[4]
						, "COD CORP" => $va1[5]
						, "STYLE NUMBER" => $va1[6]
						...
						, "SHORT_NAME" => $va1[8]
						, "PHOTOGRAF" => $va1[9]
						, "DESCRIPCION INTERNET" => $va1[10]
						, "COLOR CODE" => $va1[11]
						, "COLOR NAME" => $va1[12]
						, "COLECTION" => $va1[13]
						, "COMPOSITION" => $va1[14]
						, "LINING" => $va1[15]
						, "TYPE OF FABRIC" => $va1[16]
						, "DETAILS" => $va1[17]
						, "BEFORE MEETING REMARKS" => $va1[18]
						, "AFTER MEETING REMARKS" => $va1[19]
						, "PRODUCT DESCRIPTION" => $va1[20]
						, "STYLE GENDER" => $va1[21]
						, "SEASON" => $va1[22]
						, "TARGET VENDOR" => $va1[23]
						, "VENDOR NICK NAME" => $va1[24]
						, "VENDOR CODE" => $va1[25]
						, "COUNTRY OF ORIGIN" => $va1[26]
						, "HKO/NO HKO" => $va1[27]
						, "TARGET COST" => $va1[28]
						, "TARGET BUDGET" => $va1[29]
						, "TOTAL QUANTITY" => $va1[30]
						, "FINAL COST" => $va1[31]
						, "FINAL BUDGET" => $va1[32]
						, "LEAD TIME TYPE" => $va1[33]
						, "LOCAL BUYER" => $va1[34]
						, "LOCAL BRAND" => $va1[35]
						, "DEPARTMENT" => $va1[36]
						, "DEPARTMENT CODE" => $va1[37]
						, "LINE (*)" => $va1[38]
						, "SUBLINE" => $va1[39]
						, "SUBLNE CODE" => $va1[40]
						, "TYPE OF EXHIBITION" => $va1[41]
						, "LIFE CICLE" => $va1[42]
						, "PRODUCT SEASON" => $va1[43]
						, "TYPE OF PRODUCT" => $va1[44]
						, "PYRAMID MIX" => $va1[45]
						, "CHANCE OF USER" => $va1[46]
						, "RANKING OF SALE" => $va1[47]
						, "LIFE STYLE" => $va1[48]
						, "RETAIL PRICE" => $va1[49]
						, "PRICE RANGE" => $va1[50]
						, "2 X RETAIL PRICE" => $va1[51]
						, "ANTES/AHORA" => $va1[52]
						, "EVENTO" => $va1[53]
						, "SHIPMENT MODE" => $va1[54]
						, "VENTANA" => $va1[55]
						, "mm/dd1" => $va1[56]
						, "mm/dd2" => $va1[57]
						, "mm/dd3" => $va1[58]
						...
						, "Qty #15" => $va1[95]
						, "PREPACK" => $va1[96]
						, "HANDLING TYPE" => $va1[97]
						, "HANDLING TYPE CD" => $va1[98]
						, "SIZE STICKER" => $va1[99]
						, "UNITS PER BOX" => $va1[100]
						, "REORDER" => $va1[101]
						, "COST LAST PURCHASE" => $va1[102]
						, "VENDOR LAST PURCHASE" => $va1[103]
						, "EXTENDED WARRANTY" => $va1[104]
						, "RFID COST" => $va1[105]
						, "INSPECTION COST" => $va1[106]
						, "ROYALTY" => $va1[107]
						, "SIZE SAMPLE" => $va1[108]
						, "LOCAL BUYER P" => $va1[109]
						, "LOCAL BRAND P" => $va1[110]
						, "DEPARTMENT P" => $va1[111]
						, "DEPARTMENT CODE P" => $va1[112]
						, "LINE (*) P" => $va1[113]
						, "SUBLINE P" => $va1[114]
						, "SUBLNE CODE P" => $va1[115]
						, "HIERARCHI P" => $va1[116]
						, "LIFE CICLE P" => $va1[117]
						, "PRODUCT SEASON P" => $va1[118]
						, "PYRAMID MIX P" => $va1[119]
						, "CHANCE OF USER P" => $va1[120]
						, "RANKING OF SALE P" => $va1[121]
						, "LIFE STYLE P" => $va1[122]
						, "RETAIL PRICE P" => $va1[123]
						, "PRICE RANGE P" => $va1[124]
						, "2 X RETAIL PRICE P" => $va1[125]
						, "ANTES/AHORA P" => $va1[126]
						, "EVENTO P" => $va1[127]
						, "SHIPMENT MODE P" => $va1[128]
						, "VENTANA P" => $va1[129]
						, "mm/dd1 P" => $va1[130]
						, "mm/dd2 P" => $va1[131]
						, "mm/dd3 P" => $va1[132]
						...
						, "Qty #15 P" => $va1[169]
						, "PREPACK P" => $va1[170]
						, "HANDLING TYPE P" => $va1[171]
						, "SIZE STICKER P" => $va1[172]
						, "UNITS PER BOX P" => $va1[173]
						, "REORDER P" => $va1[174]
						, "COST LAST PURCHASE P" => $va1[175]
						, "VENDOR LAST PURCHASE P" => $va1[176]
						, "EXTENDED WARRANTY P" => $va1[177]
						, "INSPECTION NEEDED P" => $va1[178]
						, "INSPECTION COST P" => $va1[179]
						, "ROYALTY P" => $va1[180]
						, "PERU DUMPING P" => $va1[181]
						, "SIZE SAMPLE P" => $va1[182]
						)
					);
				}
			}
		...
		Public static Function Exportc1($tempo, $depto) {
			...
			foreach ($data as $va1) {
				array_push($array1,
					...
					, "Cod Corp" => $va1[9]
					, "Descripción" => $va1[10]
					, "Desc Internet" => $va1[11]
					, "Composición" => $va1[12]
					, "Colección" => $va1[13]
					, "Evento" => $va1[14]
					, "Estilo de Vida" => $va1[15]
					, "Calidad" => $va1[16]
					, "Ocasión de Uso" => $va1[17]
					, "Pirámide Mix" => $va1[18]
					, "Ventana" => $va1[19]
					, "Rank Vta" => $va1[20]
					, "Life Cycle" => $va1[21]
					, "Color" => $va1[22]
					, "Tipo Producto" => $va1[23]
					, "Tipo Exhibición" => $va1[24]
					, "Tallas" => $va1[25]
					, "Tipo Empaque" => $va1[86]
					, "% Compra Ini" => $va1[26]
					, "% Compra Ajustada" => $va1[27]
					, "Curvas de Reparto" => $va1[28]
					, "Curva Min" => $va1[29]
					, "Unid Ini" => $va1[30]
					, "Unid Ajust" => $va1[31]
					, "Unid Final" => $va1[32]
					...
					, "RFID" => $va1[55]
					, "Royalty(%)" => $va1[56]
					, "Costo Unitario Final US$" => $va1[57]
					, "Costo Unitario Final Pesos" => $va1[58]
					, "Total Target US$" => $va1[59]
					, "Total Fob US$" => $va1[60]
					, "Costo Total Pesos" => $va1[61]
					, "Total Retail Pesos(Sin IVA)" => $va1[62]
					, "Debut/Reorder" => $va1[63]
					, "Sem Ini" => $va1[64]
					, "Sem Fin" => $va1[65]
					, "Semanas Ciclo de Vida" => $va1[66]
					, "Agot Obj" => $va1[67]
					, "Semanas Liquidación" => $va1[68]
					, "Proveedor" => $va1[69]
					, "Razon Social" => $va1[70]
					, "Trader" => $va1[71]
					, "Cod Sku Proveedor" => $va1[72]
					, "Cod. Padre" => $va1[73]
					, "Proforma" => $va1[74]
					, "Archivo" => $va1[75]
					, "Estilo PMM" => $va1[76]
					...
					, "N° OC" => $va1[78]
					, "Estado OC" => $va1[79]
					, "Fecha Embarque" => $va1[80]
					, "Fecha ETA" => $va1[81]
					, "Fecha Recepción CD" => $va1[82]
					, "Días Atraso CD" => $va1[83]
					, "Estado Opción" => $va1[84]
