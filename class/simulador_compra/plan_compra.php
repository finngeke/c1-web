...
#region {*************Metodos Importar Assortment*************}
       ...
       $array= [];
        $sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_PLC_HIST_ASSORTMENT" .
            /*V_COD_TEMPORADA*/          ("(" . $cod_tempo . "" .
                ...
                /*V_NOMBRE_ESTILO*/             ",'" . $rows[$nom_columnas['Nombre Estilo']] . "'" .
                /*V_ESTILO_CORTO*/              ",'" . $rows[$nom_columnas['Estilo Corto']] . "'" .
                /*V_DESCRIPCION_ESTILO*/        ",'" . $rows[$nom_columnas['Descripcion Estilo']] . "'" .
                ...
                /*V_VENTI*/                     ","  . ($rows[$nom_columnas['VentI'] ]<> null ? ($rows[$nom_columnas['VentI']]) : 0)  . "" . ", :error, :data); end;");
        ...
        for($i =1 ;$i <= $limite; $i++) {
            ...
            $sql = "begin PLC_PKG_GENERAL.PRC_ADD_PLAN_COMPRA_COLOR_3" .
                /*V_COD_TEMPORADA*/      ("('" . $cod_tempo . "'" .
                    ...
                    /*V_COD_COLOR*/             ","  . $rows[$i][$nom_columnas['Cod Color']] . "" .
                    /*V_COD_PIRAMIX*/           ","  . plan_compra::get_codName($rows[$i][$nom_columnas['Piramide Mix']], plan_compra::list_piramidemix()) . "" .
                    /*V_PORCENTAJE*/            ",0" .
                    ...
                    /*V_VENT_HAB_INI*/          ",'" . "" . "'" .
                    /*V_VENT_HAB_FIN*/          ",'" . "" . "'" .
                    /*V_COD_RANKVTA*/           ","  . plan_compra::get_codName($rows[$i][$nom_columnas['Ranking de venta']], plan_compra::list_rnk()) . "" .
                    /*V_DSCTO_OBJ*/             ",0" .
                    /*V_DSCTO_PROM*/            ",0" .
                    /*V_STK_MIN*/               ",0" .
    ...
    public static function InsertPlanCompraAssorment2($rows,$nom_columnas,$cod_tempo,$depto,$login){
        ...
        $array=[];
        $maxid = plan_compra::get_maxidplan($cod_tempo,$depto);
            $rfid = number_format( $rows[$nom_columnas['RFID USD']], 2, '.', ',');
            $cod_vent =  plan_compra::get_codName($rows[$nom_columnas['Ventana Debut']], plan_compra::list_ventanas($cod_tempo));
            $cod_pais = plan_compra::get_codName($rows[$nom_columnas['Pais']], plan_compra::list_pais());
            $cod_via =plan_compra::get_codName($rows[$nom_columnas['Via']], plan_compra::list_via());
            $tdas = plan_compra::get_N_tdas($depto,$rows[$nom_columnas['Codigo Marca']],$cod_tempo,$rows[$nom_columnas['Cluster']], $rows[$nom_columnas['Formato']]);
            $por_Inicial = plan_compra::get_ComposicionCampos2($rows, $nom_columnas, "Size%");
            $curva_reparto = plan_compra::get_ComposicionCampos2($rows, $nom_columnas, "Curva");
            $tallas = plan_compra::get_ComposicionCampos2($rows, $nom_columnas, "Talla");
            $mstpack = plan_compra::list_mstpack($rows[$nom_columnas['Cod Linea']],$rows[$nom_columnas['Cod Sublinea']],$depto);
            $dtAjustada = plan_compra::AjustesPrimerReparto2($por_Inicial
                ...
                ,$rows[$nom_columnas['N curvas por caja curvadas']]
            ...
            $dtdiviporcent = plan_compra::Division_porcent ($dtAjustada[1]);
            $dtdivicantidad = plan_compra::Division_cantidades($dtAjustada[6]);
            $dtclustercurva= plan_compra::curvaportiendas($dtAjustada[7],$rows[$nom_columnas['ClusterA']],$rows[$nom_columnas['ClusterB']],$rows[$nom_columnas['ClusterC']],$rows[$nom_columnas['ClusterI']]);

            $Cos_Total_Target_us = ($rows[$nom_columnas['Target USD']] + $rows[$nom_columnas['RFID USD']]) *  $dtAjustada[3];
            $Cos_Uni_Finl_Pesos = plan_compra::getC_uni_finalbmt($Cos_Total_Target_us,$rows[$nom_columnas['Ventana Debut']],$cod_tempo,$depto,$cod_pais,$cod_via);
            ...
            $sql = "begin PLC_PKG_GENERAL.PRC_ADD_PLAN_COMPRA_COLOR_3" .
                /*V_COD_TEMPORADA*/      ("('" . $cod_tempo . "'" .
                    ...
                    /*V_COD_ESTILO*/            ",0" .
                    /*V_EstiloReal*/            ",'" . $rows[$nom_columnas['Nombre Estilo']] . "'" .
                    /*V_COD_COLOR*/             ","  . $rows[$nom_columnas['Cod Color']] . "" .
                    /*V_COD_PIRAMIX*/           ","  . plan_compra::get_codName($rows[$nom_columnas['Piramide Mix']], plan_compra::list_piramidemix()) . "" .
                    /*V_PORCENTAJE*/            ",0" .
                    /*V_UNIDADES*/              ","  . $dtAjustada[3] . "" . /*-Unidades finales-*/
                    /*V_USR_CRE*/               ",'" . $login . "'" .
                    /*V_USR_MOD*/               ",'" . $login . "'" .
                    /*V_SEM_INI*/               ",'" . plan_compra::SemanasIni_Fin('SemIni',$cod_vent,$cod_tempo,'','')  . "'" .
                    /*V_SEM_FIN*/               ",'" . plan_compra::SemanasIni_Fin('SemFin',$cod_vent,$cod_tempo,plan_compra::get_codName($rows[$nom_columnas['Ciclo de Vida']], plan_compra::list_ciclo_vida()),$rows[$nom_columnas['Debut o Reorder']])  . "'" .
                    /*V_CICLO*/                 ",'" . plan_compra::getsemliq_cicloA('CicloA',$rows[$nom_columnas['Ciclo de Vida']],$rows[$nom_columnas['Debut o Reorder']]) . "'" .
                    /*V_TIPO_CURVA*/            ",0" .
                    /*V_NUM_EMB*/               ",0" .
                    /*V_EMB_MIN*/               ",0" .
                    /*V_EMB_MAX*/               ",0" .
                    ...
                    /*V_VENT_HAB_INI*/          ",'" . "" . "'" .
                    /*V_VENT_HAB_FIN*/          ",'" . "" . "'" .
                    /*V_COD_RANKVTA*/           ","  . plan_compra::get_codName($rows[$nom_columnas['Ranking de venta']], plan_compra::list_rnk()) . "" .
                    /*V_DSCTO_OBJ*/             ",0" .
                    /*V_DSCTO_PROM*/            ",0" .
                    /*V_STK_MIN*/               ",0" .
                    ...
                    /*V_TIPO_CICLO*/            ",0" .
                    /*V_INDICE*/                ",0" .
                    /*V_GM*/                    ","  . round((((($rows[$nom_columnas['Precio']]/1.19)-(plan_compra::getC_uni_final($rows[$nom_columnas['Target USD']],$rfid,$rows[$nom_columnas['Ventana Debut']],$cod_tempo,$depto,$cod_pais,$cod_via)))/($rows[$nom_columnas['Precio']]/1.19))*100),2) ."".
                    /*V_ID*/                    ",0" .
                    /*V_TIPO_DSCTO*/            ",0" .
                    /*V_RATIO*/                 ",0" .
                    /*V_UNDWHITAKER*/           ",0" .
                    ...
                    /*V_VENT_EMB*/              ","  . $cod_vent . "" .
                    /*V_AGOT_OBJ*/              ",0.7".
                    /*V_SEMLIQ*/                ","  . plan_compra::getsemliq_cicloA('semLiq',$rows[$nom_columnas['Ciclo de Vida']],$rows[$nom_columnas['Debut o Reorder']]) . "" .
                    /*V_COSTO_UNIT*/            ","  .($rows[$nom_columnas['Target USD']] + $rfid).""./*-COSTO UNITARIO FINAL US$-*/
                    /*V_COSTO_UNITH*/           ",0" .
                    /*V_COSTO_TOT*/             ",0" . /*-TOTAL FOB US$-*/
                    /*V_COSTO_TOTH*/            ",0" .
                    ...
                    /*V_ESTADOCICLO*/           ",0" .
                    /*V_ESTADODIST*/            ",0" .
                    /*V_COSTO_UNITS*/           "," . plan_compra::getC_uni_final($rows[$nom_columnas['Target USD']],$rfid,$rows[$nom_columnas['Ventana Debut']]
                                                                                    ,$cod_tempo,$depto,$cod_pais,$cod_via). "" ./*-COSTO UNITARIO FINAL PESOS-*/
                    /*V_COSTO_TOTS*/            ","  . $Cos_Uni_Finl_Pesos."". /*-CALCULO COSTO TOTAL PESOS$-*/
                    /*V_BOLSA*/                 ",0" .
                    /*V_ITEM_REF*/              ",0" .
                    /*V_LIFE_CYCLE*/            ","  . plan_compra::get_codName($rows[$nom_columnas['Ciclo de Vida']], plan_compra::list_ciclo_vida()) . "" .
                    /*V_VENT_REAL*/             ",'" . $rows[$nom_columnas['Ventana Debut']] . "'" .
                    /*V_RETAIL*/                ","  . ROUND((($dtAjustada[3] * $rows[$nom_columnas['Precio']])/1.19)) . "" .  /*-RETAIL-*/
                    /*V_FORMATO*/               ",'" . $rows[$nom_columnas['Formato']] . "'" .
                    ...
                    /*V_MTR_PACK*/              ","  . $dtmstpack = plan_compra::get_mst_pack($depto,$rows[$nom_columnas['Cod Linea']],$rows[$nom_columnas['Cod Sublinea']]). "" .
                        /*V_MKUP*/                  ","  . round(($rows[$nom_columnas['Precio']]/1.19)/ (plan_compra::getC_uni_final($rows[$nom_columnas['Target USD']],$rfid,$rows[$nom_columnas['Ventana Debut']],$cod_tempo,$depto,$cod_pais,$cod_via)),2)  . "" .
                        /*V_CODSKUPROVEEDOR*/       ",0" .
                        ...
                        /*V_DIST*/                  ",0" .
                        /*V_COMPOSICION*/           ",0" .
                        /*V_TEMP*/                  ","  . plan_compra::get_codtemporadaseason2($rows, $nom_columnas) . "" .
                        /*V_COLECCION*/             ",0" .
                        /*V_COD_ESTILO_VIDA*/       ",0" .
                        /*V_DESCMODELO*/            ",'" . $rows[$nom_columnas['Descripcion Estilo']] . "'" .
                        /*V_CALIDAD*/               ",0" .
                        /*V_COD_OCASION_USO*/       ",0" .
                        /*V_ALIAS_PROV*/            ",0" .
                        /*V_COD_PROVEEDOR*/         ",0" .
                        ...
                        /*V_NOM_LINEA*/             ",'" . plan_compra::get_NomJerarquia2($dtjerarquia, $rows, $nom_columnas, 1) . "'" .
                        /*V_NOM_SUBLINEA*/          ",'" . plan_compra::get_NomJerarquia2($dtjerarquia, $rows, $nom_columnas, 2) . "'" .
                        /*V_NOM_MARCA*/             ",'" . plan_compra::get_NomMarcas2($dtmarcas, $rows, $nom_columnas) . "'" .
                        /*V_NOM_ESTILOVIDA*/        ",''".
                        /*V_NOM_CALIDAD*/           ",''".
                        /*V_NOM_OCACIONUSO*/        ",''".
                        ...
                        /*V_NOM_PROCEDENCIA*/       ",'IMP'".
                        /*V_NOM_VIA*/               ",'" . $rows[$nom_columnas['Via']] . "'" .
                        /*V_NOM_PAIS*/              ",'" . $rows[$nom_columnas['Pais']] . "'" .
                        /*V_NOM_MONEDA*/            ",'USD'".
                        /*V_NOM_RAZONSOCIAL*/       ",''".
                        /*V_NOM_TRADER*/            ",''".
                        ...
                        /*V_I*/                     ","  . $dtclustercurva[3] . "" .
                        /*V_INTERNET_DESCRIPTION*/  ",''".
                        /*V_COSTO_RFID*/            ","  . $rows[$nom_columnas['RFID USD']] . "" .
                        /*V_ERROR_PI*/              ",''".
                        /*V_SHORT_NAME*/            ",'" . $rows[$nom_columnas['Estilo Corto']] . "'".
                        /*V_N_CURVASXCAJAS*/        ","  . $rows[$nom_columnas['N curvas por caja curvadas']] . ", :error, :data); end;");
         ...
         if ($_insert <> false){
            $sql = "begin PLC_PKG_UTILS.PRC_ADD_PLAN_COMPRA_COLOR_CIC" .
                /*V_COD_TEMPORADA*/     ("('" . $cod_tempo . "'" .
                    ...
                    /*V_VTA_SIGV*/              ",0" .
                    /*V_COSTO*/                 ",0" .//FALTA CALCULO
                    /*V_VTA_CDSCTO*/            ","  . round((($dtAjustada[3] * $rows[$nom_columnas['Precio']])/1.19),0) . "" .
                    /*V_GM*/                    ","  . round((((($rows[$nom_columnas['Precio']]/1.19)-(plan_compra::getC_uni_final($rows[$nom_columnas['Target USD']],$rfid,$rows[$nom_columnas['Ventana Debut']],$cod_tempo,$depto,$cod_pais,$cod_via)))/($rows[$nom_columnas['Precio']]/1.19))*100),2) ."".
                    /*V_PERIODO*/               ","  . plan_compra::get_codName($rows[$nom_columnas['Ventana Debut']], plan_compra::list_ventanas($cod_tempo)) . "" .
                    /*V_SEM_CORTA*/             ",0" .
                    /*V_ID*/                    ",0" .
                    /*V_ID_COLOR3*/             ","  . $key . ", :error, :data); end;");
        ...
        if ($_insert <> false){
            $sql = "begin PLC_PKG_PRUEBA.PRC_ADD_PLAN_HISTORICO" .
                /*V_TEMP*/         ("('" . $cod_tempo . "'" .
                    ...
                    /*V_ESTILO*/        ",'" . $rows[$nom_columnas['Nombre Estilo']] . "'" .
                    /*V_VENTANA*/       ","  . plan_compra::get_codName($rows[$nom_columnas['Ventana Debut']], plan_compra::list_ventanas($cod_tempo)) . "" .
        ...
        if ($_insert <> false) {
            ...
            $_error = plan_compra::SaveAjuste_Compra(/*AJUSTE DE COMPRA*/$dtAjustada[8]
                                                     ...
                                                     /*AJUSTE SOLIDO FUL*/, $dtAjustada[11]
                                                     /*AJUSTE REORDER*/, $dtAjustada[12]
                                                     /*DEBUT/REORDER*/, $rows[$nom_columnas['Debut o Reorder']]
                                                     /*TIPO EMPAQUE*/, trim(strtoupper($rows[$nom_columnas['Tipo de empaque']]))
                                                     /*ID_COLOR3*/, $key
                                                     /*Tallas*/, $tallas
                                                     /*TEMPO*/, $cod_tempo
                                                     /*DEPTO*/, $depto);
            if (count($_error) == 1) {
                $_insert = false;
                $array = array('Tipo' => $_error["Tipo"],
                    'Error' => "Guardado Tabla Ajuste =|" . $_error["Error"] . "|");
            }
        }
    ...
    public static function InsertHistorialBmt($rows,$limite,$nom_columnas,$cod_tempo,$depto){
        ...
        for($i =1 ;$i <= $limite; $i++) {
            ...
            $sql = "begin PLC_PKG_DESARROLLO.PRC_ADD_HIS_IMPORT_BMT" .
                    /*v_purchase_group*/            ("('".$rows[$i][$nom_columnas['PURCHASE GROUP']] . "'" .
                    /*v_corporate_buyer_name*/      ",'" .$rows[$i][$nom_columnas['CORPORATE BUYER NAME']]. "'" .
                    /*v_disigner_name*/             ",'" .$rows[$i][$nom_columnas['DISIGNER NAME']]. "'" .
                    /*v_pi_season*/                 ",'" .$rows[$i][$nom_columnas['PI SEASON']]. "'" .
                    /*v_style_number*/              ",'" .$rows[$i][$nom_columnas['STYLE NUMBER']]. "'" .
                    /*v_stye_name*/                 ",'" .$rows[$i][$nom_columnas['STYLE NAME']]. "'" .
                    /*v_short_name*/                ",'" .$rows[$i][$nom_columnas['SHORT_NAME']]. "'" .
                    /*v_photograf*/                 ",'" .$rows[$i][$nom_columnas['PHOTOGRAF']]. "'" .
                    /*v_color_code*/                ",'" .$rows[$i][$nom_columnas['COLOR CODE']]. "'" .
                    /*v_color_name*/                ",'" .$rows[$i][$nom_columnas['COLOR NAME']]. "'" .
                    /*v_colection*/                 ",'" .$rows[$i][$nom_columnas['COLECTION']]. "'" .
                    /*v_composition*/               ",'" .$rows[$i][$nom_columnas['COMPOSITION']]. "'" .
                    /*v_lining*/                    ",'" .$rows[$i][$nom_columnas['LINING']]. "'" .
                    /*v_type_of_fabric*/            ",'" .$rows[$i][$nom_columnas['TYPE OF FABRIC']]. "'" .
                    /*v_details*/                   ",'" .$rows[$i][$nom_columnas['DETAILS']]. "'" .
                    /*v_before_meeting_remarks*/    ",'" .$rows[$i][$nom_columnas['BEFORE MEETING REMARKS']]. "'" .
                    /*v_after_meeting_remarks*/     ",'" .$rows[$i][$nom_columnas['AFTER MEETING REMARKS']]. "'" .
                    /*v_product_description*/       ",'" .$rows[$i][$nom_columnas['PRODUCT DESCRIPTION']]. "'" .
                    /*v_style_gender*/              ",'" .$rows[$i][$nom_columnas['STYLE GENDER']]. "'" .
                    /*v_season*/                    ",'" .$rows[$i][$nom_columnas['SEASON']]. "'" .
                    /*v_target_vendedor*/           ",'" .$rows[$i][$nom_columnas['TARGET VENDOR']]. "'" .
                    /*v_vendor_nick_name*/          ",'" .$rows[$i][$nom_columnas['VENDOR NICK NAME']]. "'" .
                    /*v_vendor_code*/               ",'" .$rows[$i][$nom_columnas['VENDOR CODE']]. "'" .
                    /*v_country_of_origin*/         ",'" .$rows[$i][$nom_columnas['COUNTRY OF ORIGIN']]. "'" .
                    /*v_hko_no_hko*/                ",'" .$rows[$i][$nom_columnas['HKO/NO HKO']]. "'" .
                    /*v_target_cost*/               ",'" .$rows[$i][$nom_columnas['TARGET COST']]. "'" .
                    /*v_target_budget*/             ",'" .$rows[$i][$nom_columnas['TARGET BUDGET']]. "'" .
                    /*v_total_quantity*/            ",'" .$rows[$i][$nom_columnas['TOTAL QUANTITY']]. "'" .
                    /*v_final_costo*/               ",'" .$rows[$i][$nom_columnas['FINAL COST']]. "'" .
                    /*v_final_burget*/              ",'" .$rows[$i][$nom_columnas['FINAL BUDGET']]. "'" .
                    /*v_lead_time_type*/            ",'" .$rows[$i][$nom_columnas['LEAD TIME TYPE']]. "'" .
                    /*v_local_buyer*/               ",'" .$rows[$i][$nom_columnas['LOCAL BUYER']]. "'" .
                    /*v_local_brand*/               ",'" .$rows[$i][$nom_columnas['LOCAL BRAND']]. "'" .
                    /*v_department*/                ",'" .$rows[$i][$nom_columnas['DEPARTMENT']]. "'" .
                    /*v_department_code*/           ",'" .$rows[$i][$nom_columnas['DEPARTMENT CODE']]. "'" .
                    /*v_temporada*/                 ",'" .$cod_tempo. "'" .
                    /*v_line*/                      ",'" .$rows[$i][$nom_columnas['LINE (*)']]. "'" .
                    /*v_subline*/                   ",'" .$rows[$i][$nom_columnas['SUBLINE']]. "'" .
                    /*v_subline_code*/              ",'" .$rows[$i][$nom_columnas['SUBLNE CODE']]. "'" .
                    /*v_hierarchi*/                 ",''".
                    /*v_life_cicle*/                ",'" .$rows[$i][$nom_columnas['LIFE CICLE']]. "'" .
                    /*v_product_season*/            ",'" .$rows[$i][$nom_columnas['PRODUCT SEASON']]. "'" .
                    /*v_pyramid_mix*/               ",'" .$rows[$i][$nom_columnas['PYRAMID MIX']]. "'" .
                    /*v_type_product*/              ",'" .$rows[$i][$nom_columnas['TYPE OF PRODUCT']]. "'" .
                    /*v_chance_of_user*/            ",'" .$rows[$i][$nom_columnas['CHANCE OF USER']]. "'" .
                    /*v_ranking_of_sale*/           ",'" .$rows[$i][$nom_columnas['RANKING OF SALE']]. "'" .
                    /*v_life_style*/                ",'" .$rows[$i][$nom_columnas['LIFE STYLE']]. "'" .
                    /*v_ratail_price*/              ",'" .$rows[$i][$nom_columnas['RETAIL PRICE']]. "'" .
                    /*v_price_range*/               ",'" .$rows[$i][$nom_columnas['PRICE RANGE']]. "'" .
                    /*v_dos_x_retail_price*/        ",'" .$rows[$i][$nom_columnas['2 X RETAIL PRICE']]. "'" .
                    /*v_antes_ahora*/               ",'" .$rows[$i][$nom_columnas['ANTES/AHORA']]. "'" .
                    /*v_evento*/                    ",'" .$rows[$i][$nom_columnas['EVENTO']]. "'" .
                    /*v_shipment_mode*/             ",'" .$rows[$i][$nom_columnas['SHIPMENT MODE']]. "'" .
                    /*v_ventana*/                   ",'" .$rows[$i][$nom_columnas['VENTANA']]. "'" .
                    /*v_mm_dd1*/                    ",'" .$rows[$i][$nom_columnas['mm/dd1']]. "'" .
                    /*v_mm_dd2*/                    ",'" .$rows[$i][$nom_columnas['mm/dd2']]. "'" .
                    /*v_mm_dd3*/                    ",'" .$rows[$i][$nom_columnas['mm/dd3']]. "'" .
                    /*v_mm_dd4*/                    ",'" .$rows[$i][$nom_columnas['mm/dd4']]. "'" .
                    /*v_mm_dd5*/                    ",'" .$rows[$i][$nom_columnas['mm/dd5']]. "'" .
                    /*v_mm_dd6*/                    ",'" .$rows[$i][$nom_columnas['mm/dd6']]. "'" .
                    /*v_mm_dd7*/                    ",'" .$rows[$i][$nom_columnas['mm/dd7']]. "'" .
                    /*v_total_quantity_cl*/         ",'" .$rows[$i][$nom_columnas['TOTAL QUANTITY CL']]. "'" .
                    /*v_size_type*/                 ",''".
                    /*v_size_*/                     ",'" .$rows[$i][$nom_columnas['SIZE']]. "'" .
                    /*v_size_por_1*/                ",'" .$rows[$i][$nom_columnas['Size %1']]. "'" .
                    /*v_size_por_2*/                ",'" .$rows[$i][$nom_columnas['Size %2']]. "'" .
                    /*v_size_por_3*/                ",'" .$rows[$i][$nom_columnas['Size %3']]. "'" .
                    /*v_size_por_4*/                ",'" .$rows[$i][$nom_columnas['Size %4']]. "'" .
                    /*v_size_por_5*/                ",'" .$rows[$i][$nom_columnas['Size %5']]. "'" .
                    /*v_size_por_6*/                ",'" .$rows[$i][$nom_columnas['Size %6']]. "'" .
                    /*v_size_por_7*/                ",'" .$rows[$i][$nom_columnas['Size %7']]. "'" .
                    /*v_size_por_8*/                ",'" .$rows[$i][$nom_columnas['Size %8']]. "'" .
                    /*v_size_por_9*/                ",'" .$rows[$i][$nom_columnas['Size %9']]. "'" .
                    /*v_size_por_10*/               ",'" .$rows[$i][$nom_columnas['Size %10']]. "'" .
                    /*v_size_por_11*/               ",'" .$rows[$i][$nom_columnas['Size %11']]. "'" .
                    /*v_size_por_12*/               ",'" .$rows[$i][$nom_columnas['Size %12']]. "'" .
                    /*v_size_por_13*/               ",'" .$rows[$i][$nom_columnas['Size %13']]. "'" .
                    /*v_size_por_14*/               ",'" .$rows[$i][$nom_columnas['Size %14']]. "'" .
                    /*v_size_por_15*/               ",'" .$rows[$i][$nom_columnas['Size %15']]. "'" .
                    /*v_qty_coun_1*/                ",'" .$rows[$i][$nom_columnas['Qty #1']]. "'" .
                    /*v_qty_coun_2*/                ",'" .$rows[$i][$nom_columnas['Qty #2']]. "'" .
                    /*v_qty_coun_3*/                ",'" .$rows[$i][$nom_columnas['Qty #3']]. "'" .
                    /*v_qty_coun_4*/                ",'" .$rows[$i][$nom_columnas['Qty #4']]. "'" .
                    /*v_qty_coun_5*/                ",'" .$rows[$i][$nom_columnas['Qty #5']]. "'" .
                    /*v_qty_coun_6*/                ",'" .$rows[$i][$nom_columnas['Qty #6']]. "'" .
                    /*v_qty_coun_7*/                ",'" .$rows[$i][$nom_columnas['Qty #7']]. "'" .
                    /*v_qty_coun_8*/                ",'" .$rows[$i][$nom_columnas['Qty #8']]. "'" .
                    /*v_qty_coun_9*/                ",'" .$rows[$i][$nom_columnas['Qty #9']]. "'" .
                    /*v_qty_coun_10*/               ",'" .$rows[$i][$nom_columnas['Qty #10']]. "'" .
                    /*v_qty_coun_11*/               ",'" .$rows[$i][$nom_columnas['Qty #11']]. "'" .
                    /*v_qty_coun_12*/               ",'" .$rows[$i][$nom_columnas['Qty #12']]. "'" .
                    /*v_qty_coun_13*/               ",'" .$rows[$i][$nom_columnas['Qty #13']]. "'" .
                    /*v_qty_coun_14*/               ",'" .$rows[$i][$nom_columnas['Qty #14']]. "'" .
                    /*v_qty_coun_15*/               ",'" .$rows[$i][$nom_columnas['Qty #15']]. "'" .
                    /*v_prepack*/                   ",'" .$rows[$i][$nom_columnas['PREPACK']]. "'" .
                    /*v_handling_type*/             ",'" .$rows[$i][$nom_columnas['HANDLING TYPE']]. "'" .
                    /*v_handling_type_cd*/          ",'" .$rows[$i][$nom_columnas['HANDLING TYPE CD']]. "'" .
                    /*v_size_sticker*/              ",'" .$rows[$i][$nom_columnas['SIZE STICKER']]. "'" .
                    /*v_units_per_box*/             ",'" .$rows[$i][$nom_columnas['UNITS PER BOX']]. "'" .
                    /*v_reorder*/                   ",'" .$rows[$i][$nom_columnas['REORDER']]. "'" .
                    /*v_cost_last_purchase*/        ",'" .$rows[$i][$nom_columnas['COST LAST PURCHASE']]. "'" .
                    /*v_vendor_last_purchase*/      ",'" .$rows[$i][$nom_columnas['VENDOR LAST PURCHASE']]. "'" .
                    /*v_extended_warranty*/         ",'" .$rows[$i][$nom_columnas['EXTENDED WARRANTY']]. "'" .
                    /*v_inspection_needed*/         ",''".
                    /*v_inspection_cost*/           ",'" .$rows[$i][$nom_columnas['INSPECTION COST']]. "'" .
                    /*v_royalty*/                   ",'" .$rows[$i][$nom_columnas['ROYALTY']]. "'" .
                    /*v_size_sample*/               ",'" .$rows[$i][$nom_columnas['SIZE SAMPLE']]. "'" .
                    /*v_cod_corp*/                  ",'" .$rows[$i][$nom_columnas['COD CORP']]. "'" .
                    /*v_internet_description*/      ",'" .$rows[$i][$nom_columnas['DESCRIPCION INTERNET']]. "'" .
                    /*v_cluster_r*/                 ",'" .$rows[$i][$nom_columnas['CLUSTER']]. "'" .
                    /*v_cost_rfid*/                 ",'" .$rows[$i][$nom_columnas['RFID COST']]. "'" .
                    /*v_tipo_exhibicion*/           ",'" .$rows[$i][$nom_columnas['TYPE OF EXHIBITION']]. "'" .
                    /*v_local_buyer_peru*/          ",'" .$rows[$i][$nom_columnas['LOCAL BUYER P']]. "'" .
                    /*v_local_brand_peru*/          ",'" .$rows[$i][$nom_columnas['LOCAL BRAND P']]. "'" .
                    /*v_department_peru*/           ",'" .$rows[$i][$nom_columnas['DEPARTMENT P']]. "'" .
                    /*v_department_code_peru*/      ",'" .$rows[$i][$nom_columnas['DEPARTMENT CODE P']]. "'" .
                    /*v_line_peru*/                 ",'" .$rows[$i][$nom_columnas['LINE (*) P']]. "'" .
                    /*v_subline_peru*/              ",'" .$rows[$i][$nom_columnas['SUBLINE P']]. "'" .
                    /*v_subline_code_peru*/         ",'" .$rows[$i][$nom_columnas['SUBLNE CODE P']]. "'" .
                    /*v_hierarchi_peru*/            ",'" .$rows[$i][$nom_columnas['HIERARCHI P']]. "'" .
                    /*v_life_cicle_peru*/           ",'" .$rows[$i][$nom_columnas['LIFE CICLE P']]. "'" .
                    /*v_product_season_peru*/       ",'" .$rows[$i][$nom_columnas['PRODUCT SEASON P']]. "'" .
                    /*v_pyramid_mix_peru*/          ",'" .$rows[$i][$nom_columnas['PYRAMID MIX P']]. "'" .
                    /*v_chance_of_user_peru*/       ",'" .$rows[$i][$nom_columnas['CHANCE OF USER P']]. "'" .
                    /*v_ranking_of_sale_peru*/      ",'" .$rows[$i][$nom_columnas['RANKING OF SALE P']]. "'" .
                    /*v_life_style_peru*/           ",'" .$rows[$i][$nom_columnas['LIFE STYLE P']]. "'" .
                    /*v_ratail_price_peru*/         ",'" .$rows[$i][$nom_columnas['RETAIL PRICE P']]. "'" .
                    /*v_price_range_peru*/          ",'" .$rows[$i][$nom_columnas['2 X RETAIL PRICE P']]. "'" .
                    /*v_dos_x_retail_price_peru*/   ",'" .$rows[$i][$nom_columnas['ANTES/AHORA P']]. "'" .
                    /*v_antes_ahora_peru*/          ",'" .$rows[$i][$nom_columnas['EVENTO P']]. "'" .
                    /*v_evento_peru*/               ",'" .$rows[$i][$nom_columnas['SHIPMENT MODE P']]. "'" .
                    /*v_shipment_mode_peru*/        ",'" .$rows[$i][$nom_columnas['SHIPMENT MODE P']]. "'" .
                    /*v_ventana_peru*/              ",'" .$rows[$i][$nom_columnas['VENTANA P']]. "'" .
                    /*v_mm_dd1_peru*/               ",'" .$rows[$i][$nom_columnas['mm/dd1 P']]. "'" .
                    /*v_mm_dd2_peru*/               ",'" .$rows[$i][$nom_columnas['mm/dd2 P']]. "'" .
                    /*v_mm_dd3_peru*/               ",'" .$rows[$i][$nom_columnas['mm/dd3 P']]. "'" .
                    /*v_mm_dd4_peru*/               ",'" .$rows[$i][$nom_columnas['mm/dd4 P']]. "'" .
                    /*v_mm_dd5_peru*/               ",'" .$rows[$i][$nom_columnas['mm/dd5 P']]. "'" .
                    /*v_mm_dd6_peru*/               ",'" .$rows[$i][$nom_columnas['mm/dd6 P']]. "'" .
                    /*v_mm_dd7_peru*/               ",'" .$rows[$i][$nom_columnas['mm/dd7 P']]. "'" .
                    /*v_total_quantity_cl_peru*/    ",'" .$rows[$i][$nom_columnas['TOTAL QUANTITY P']]. "'" .
                    /*v_size_type_peru*/            ",'" .$rows[$i][$nom_columnas['SIZE TYPE P']]. "'" .
                    /*v_size__peru*/                ",'" .$rows[$i][$nom_columnas['SIZE P']]. "'" .
                    /*v_size_por_1_peru*/           ",'" .$rows[$i][$nom_columnas['Size %1 P']]. "'" .
                    /*v_size_por_2_peru*/           ",'" .$rows[$i][$nom_columnas['Size %2 P']]. "'" .
                    /*v_size_por_3_peru*/           ",'" .$rows[$i][$nom_columnas['Size %3 P']]. "'" .
                    /*v_size_por_4_peru*/           ",'" .$rows[$i][$nom_columnas['Size %4 P']]. "'" .
                    /*v_size_por_5_peru*/           ",'" .$rows[$i][$nom_columnas['Size %5 P']]. "'" .
                    /*v_size_por_6_peru*/           ",'" .$rows[$i][$nom_columnas['Size %6 P']]. "'" .
                    /*v_size_por_7_peru*/           ",'" .$rows[$i][$nom_columnas['Size %7 P']]. "'" .
                    /*v_size_por_8_peru*/           ",'" .$rows[$i][$nom_columnas['Size %8 P']]. "'" .
                    /*v_size_por_9_peru*/           ",'" .$rows[$i][$nom_columnas['Size %9 P']]. "'" .
                    /*v_size_por_10_peru*/          ",'" .$rows[$i][$nom_columnas['Size %10 P']]. "'" .
                    /*v_size_por_11_peru*/          ",'" .$rows[$i][$nom_columnas['Size %12 P']]. "'" .
                    /*v_size_por_12_peru*/          ",'" .$rows[$i][$nom_columnas['Size %13 P']]. "'" .
                    /*v_size_por_13_peru*/          ",'" .$rows[$i][$nom_columnas['Size %14 P']]. "'" .
                    /*v_size_por_14_peru*/          ",'" .$rows[$i][$nom_columnas['Size %14 P']]. "'" .
                    /*v_size_por_15_peru*/          ",'" .$rows[$i][$nom_columnas['Size %15 P']]. "'" .
                    /*v_qty_coun_1_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #1 P']]. "'" .
                    /*v_qty_coun_2_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #2 P']]. "'" .
                    /*v_qty_coun_3_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #3 P']]. "'" .
                    /*v_qty_coun_4_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #4 P']]. "'" .
                    /*v_qty_coun_5_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #5 P']]. "'" .
                    /*v_qty_coun_6_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #6 P']]. "'" .
                    /*v_qty_coun_7_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #7 P']]. "'" .
                    /*v_qty_coun_8_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #8 P']]. "'" .
                    /*v_qty_coun_9_peru*/           ",'" .$rows[$i][$nom_columnas['Qty #9 P']]. "'" .
                    /*v_qty_coun_10_peru*/          ",'" .$rows[$i][$nom_columnas['Qty #10 P']]. "'" .
                    /*v_qty_coun_11_peru*/          ",'" .$rows[$i][$nom_columnas['Qty #11 P']]. "'" .
                    /*v_qty_coun_12_peru*/          ",'" .$rows[$i][$nom_columnas['Qty #12 P']]. "'" .
                    /*v_qty_coun_13_peru*/          ",'" .$rows[$i][$nom_columnas['Qty #13 P']]. "'" .
                    /*v_qty_coun_14_peru*/          ",'" .$rows[$i][$nom_columnas['Qty #14 P']]. "'" .
                    /*v_qty_coun_15_peru*/          ",'" .$rows[$i][$nom_columnas['Qty #15 P']]. "'" .
                    /*v_prepack_peru*/              ",'" .$rows[$i][$nom_columnas['PREPACK P']]. "'" .
                    /*v_handling_type_peru*/        ",'" .$rows[$i][$nom_columnas['HANDLING TYPE P']]. "'" .
                    /*v_size_sticker_peru*/         ",'" .$rows[$i][$nom_columnas['SIZE STICKER P']]. "'" .
                    /*v_units_per_box_peru*/        ",'" .$rows[$i][$nom_columnas['UNITS PER BOX P']]. "'" .
                    /*v_reorder_peru*/              ",'" .$rows[$i][$nom_columnas['REORDER P']]. "'" .
                    /*v_cost_last_purchase_peru*/   ",'" .$rows[$i][$nom_columnas['COST LAST PURCHASE P']]. "'" .
                    /*v_vendor_last_purchase_peru*/ ",'" .$rows[$i][$nom_columnas['VENDOR LAST PURCHASE P']]. "'" .
                    /*v_extended_warranty_peru*/    ",'" .$rows[$i][$nom_columnas['EXTENDED WARRANTY P']]. "'" .
                    /*v_inspection_needed_peru*/    ",'" .$rows[$i][$nom_columnas['INSPECTION NEEDED P']]. "'" .
                    /*v_inspection_cost_peru*/      ",'" .$rows[$i][$nom_columnas['INSPECTION COST P']]. "'" .
                    /*v_royalty_peru*/              ",'" .$rows[$i][$nom_columnas['ROYALTY P']]. "'" .
                    /*v_peru_dumping_peru*/         ",'" .$rows[$i][$nom_columnas['PERU DUMPING P']]. "'" .
                    /*v_size_sample_peru*/          ",'" .$rows[$i][$nom_columnas['SIZE SAMPLE P']]. "'" .
                    /*v_id_color3*/                 ","  .$rows[$i][$nom_columnas['ID C1']]. ", :error, :data); end;");
            $data = \database::getInstancia()->getConsultaSP($sql, 2);
