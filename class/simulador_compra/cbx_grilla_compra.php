    ...
    public static function llenar_tabla2_base($temporada, $depto)
    {
        ...
        foreach ($data as $va1){
            array_push($array1
                ...
                ,"COLECCION"=> $va1[17]
                ,"EVENTO"=> $va1[18]
                ,"COD_ESTILO_VIDA"=> $va1[19]
                ,"CALIDAD"=> $va1[20]
                ,"COD_OCASION_USO"=> $va1[21]
                ,"COD_PIRAMIX"=> $va1[22]
                ,"DESCRIPCION"=> $va1[23] //ventana
                ,"COD_RANKVTA"=> $va1[24]
                ,"LIFE_CYCLE"=> $va1[25]
                ,"NUM_EMB"=> $va1[26]
                ,"COD_COLOR"=> $va1[27]
                ,"TIPO_PRODUCTO"=> $va1[28]
                ,"TIPO_EXHIBICION"=> $va1[29]
                ,"DESTALLA"=> $va1[30]
                ,"TIPO_EMPAQUE"=> $va1[31]
                ,"PORTALLA_1_INI"=> $va1[32]
                ,"PORTALLA_1"=> $va1[33]
                ,"CURVATALLA"=> $va1[34]
                ,"CURVAMIN"=> $va1[35]
                ,"UNID_OPCION_INICIO"=> $va1[36]
                ,"UNID_OPCION_AJUSTADA"=> $va1[37]
                ,"CAN"=> $va1[38]
                ,"MTR_PACK"=> $va1[39]
                ,"CANT_INNER"=> $va1[40]
                ,"SEG_ASIG"=> $va1[41]
                ...
                ,"UND_ASIG_INI"=> $va1[48]
                ,"ROT"=> $va1[49]
                ,"NOM_PRECEDENCIA"=> $va1[50]
                ,"NOM_VIA"=> $va1[51]
                ,"NOM_PAIS"=> $va1[52]
                ,"VIAJE"=> $va1[53]
                ,"MKUP"=> $va1[54]
                ,"PRECIO_BLANCO"=> $va1[55]
                ,"OFERTA"=> $va1[56]
                ,"GM"=> $va1[57]
                ,"COD_TIP_MON"=> $va1[58]
                ,"COSTO_TARGET"=> $va1[59]
                ...
                ,"SEMLIQ"=> $va1[75]
                ,"ALIAS_PROV"=> $va1[76]
                ,"COD_PROVEEDOR"=> $va1[77]
                ,"COD_TRADER"=>$va1[78]
                ,"AFTER_MEETING_REMARKS"=>$va1[79]
                ,"CODSKUPROVEEDOR"=> $va1[80]
                ,"SKU"=> $va1[81]
                ,"PROFORMA"=> $va1[82]
                ,"ARCHIVO"=> $va1[83]
                ,"ESTILO_PMM"=> $va1[84]
                ...
                ,"PO_NUMBER"=> $va1[86]
                ,"ESTADO_OC"=> $va1[87]
                ,"FECHA_ACORDADA"=> $va1[88]
                ,"FECHA_EMBARQUE"=> $va1[89]
                ,"FECHA_ETA"=> $va1[90]
                ,"FECHA_RECEPCION"=> $va1[91]
                ,"DIAS_ATRASO"=> $va1[91]
                ,"CODESTADO"=> $va1[93]
                ,"ESTADO_C1"=> $va1[94]
                ,"VENTANA_LLEGADA"=> $va1[95]
                ,"FECHA_RECEPCD_C1"=> $va1[96]
                )
            );
        }
