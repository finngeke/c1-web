 ...
 * @author Roberto Pérez 03-04-2018
 */
...
class curva
{
    ...
    public static function getCurva($temporada, $depto)
    {
        $sql = "begin PLC_PKG_MIGRACION.PRC_LISTAR_CONFIGCURVAREPARTO('" . $temporada . "','" . $depto . "', :data); end";
    ...
    public static function quitarFormato($temporada, $depto, $formato, $asignado)
    {
        ...
        try {
            ...
            $sql = "DELETE FROM PLC_PKG_GENERAL.plc_formatos_tda
    ...
    public static function almacenaFormato($temporada, $depto, $formato, $asignado)
    {
        ...
        try {
            $sql = "INSERT INTO PLC_PKG_GENERAL.PLC_FORMATOS_TDA( 
                          COD_TEMPORADA ,
                          DEP_DEPTO     ,
                          NIV_JER1 ,
                          COD_JER1,
    ...
    // Almacena Nuevo Formato (Enviad-o desde el modal)
